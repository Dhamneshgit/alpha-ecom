...
Route::get('certificate/{user_id}', 'Admin\CustomerController@certificate')->name('certificate');

Route::get('seller_certificate/{id}', 'Admin\SellerController@sellerCertificate')->name('certificates');
...
Route::group(['namespace' => 'Web'], function () {
    ...
    // });
    Route::get('/', 'HomeController@index')->name('home');
    // Route::get('/frontend/delete_user', 'HomeController@delete_user')->name('delete_user');
    // Route::post('/frontend/deleteuser', 'HomeController@deleteAccount')->name('deleteuser');
    Route::post('update_city_session', 'HomeController@updateCitySession')->name('update_city_session');
    ...
    Route::group(['middleware' => ['customer']], function () {
        ...
        Route::post('store_service', 'ReviewController@store_service')->name('review.store_service');
    ...
    Route::get('service-category', 'WebController@service_category')->name('service-category');
    ...
    Route::get('flash-deal', 'WebController@flash_deals')->name('flash-deal');
    ...
    // services controller 
    Route::get('services/{id}', 'ServiceListController@show')->name('services');
    Route::get('singleservices/{id}', 'ServiceListController@showsingleservice')->name('singleservices');
    Route::post('services-booking', 'ServiceListController@bookingServices')->name('services-booking');
    Route::post('get_timeslots', 'ServiceListController@getTimeSlot');
    ...
    Route::get('my-service', 'UserProfileController@my_service')->name('my-service')->middleware('customer');
    Route::get('return-orders', 'UserProfileController@return_orders')->name('return-orders')->middleware('customer');
    Route::post('payment-option', 'UserProfileController@payment_option')->name('payment-option')->middleware('customer');
    ...
    Route::get('return-order-details', 'UserProfileController@return_order_details')->name('return-order-details')->middleware('customer');
...
// to fetch services and route on services page
// Route::get('services', 'ServiceListController@services_get')->name('services');
