...
Route::group(['namespace' => 'Customer', 'prefix' => 'customer', 'as' => 'customer.'], function () {
    ...
    Route::group(['namespace' => 'Auth', 'prefix' => 'auth', 'as' => 'auth.'], function () {
        ...
        // with otp
        Route::post('login_with_otp', 'LoginController@submit_with_otp')->name('login_with_otp');
        Route::post('send_otp', 'LoginController@send_otp')->name('send_otp');
    ...
    Route::group(['prefix' => 'payment-mobile'], function () {
        ...
        Route::get('/pay-now', 'PaymentController@payNow')->name('pay-now');
    });
