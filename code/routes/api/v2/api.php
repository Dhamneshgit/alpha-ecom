...
Route::group(['namespace' => 'api\v2', 'prefix' => 'v2', 'middleware' => ['api_lang']], function () {
    ...
    Route::group(['prefix' => 'delivery-man', 'namespace' => 'delivery_man'], function () {
        ...
        Route::group(['prefix' => 'auth', 'namespace' => 'auth'], function () {
            Route::post('login', 'LoginController@login');
            Route::post('add_delivery_boy', 'LoginController@add_delivery_boy');
            Route::post('delivery_boy_list', 'LoginController@delivery_boy_list');
        ...
        Route::group(['middleware' => ['delivery_man_auth']], function () {
            ...
            Route::post('order_status', 'DeliveryManController@order_status');
