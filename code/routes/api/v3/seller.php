...
Route::group(['namespace' => 'api\v3\seller', 'prefix' => 'v3/seller', 'middleware' => ['api_lang']], function () {
        ...
        Route::group(['middleware' => ['seller_api_auth']], function () {
            Route::get('bonustransaction', 'SellerController@bonustransaction');
            Route::get('get-delivery-man', 'SellerController@getDeliveryMan');
            Route::post('assign-delivery-man', 'SellerController@assignDeliveryMan');
            Route::get('seller-info', 'SellerController@seller_info');
            Route::get('get_wallet_transaction', 'SellerController@getWalletTransaction');
            Route::post('add_money', 'SellerController@addMoney');
            Route::post('request_money', 'SellerController@requestMoney');
            Route::post('get_request_money', 'SellerController@getRequestMoney');
            ...
            Route::group(['prefix' => 'services'], function () {
                ...
                Route::get('details/{id}', 'ServiceController@details');
                Route::put('update/{id}', 'ServiceController@update');
                Route::delete('delete/{id}', 'ServiceController@delete');
                Route::get('my_booking', 'ServiceController@myBooking');
                Route::post('update_booking_status', 'ServiceController@updateBookingStatus');
                Route::post('add_time_slots', 'ServiceController@addTimeSlots');
                Route::post('upadte_time_slot', 'ServiceController@updateTimeSlots');
                Route::post('delete_time_slot/{id}', 'ServiceController@deleteTimeSlots');
                Route::post('get_timeslots', 'ServiceController@getTimeSlot');
                Route::post('reschedule_service', 'ServiceController@rescheduleService');
                // Route::get('my_booking', 'ServiceController@myBooking');
                // Route::get('stock-out-list', 'ProductController@stock_out_list');
                // Route::put('status-update', 'ProductController@status_update');
                // Route::get('edit/{id}', 'ProductController@edit');
