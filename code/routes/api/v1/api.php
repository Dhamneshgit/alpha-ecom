...
Route::group(['namespace' => 'api\v1', 'prefix' => 'v1', 'middleware' => ['api_lang']], function () {
    ...
    Route::group(['prefix' => 'auth', 'namespace' => 'auth'], function () {
        ...
        Route::post('testNotification', 'PassportAuthController@testNotification');
        Route::post('testshipmozo', 'PassportAuthController@testshipmozo');
        Route::post('doctor_register', 'PassportAuthController@registerDoctor');
        Route::post('manufacture_register', 'PassportAuthController@registerManufacture');
        Route::post('aggregator_register', 'PassportAuthController@registerAggregator');
        Route::post('login', 'PassportAuthController@login');
        Route::post('add_kyc', 'PassportAuthController@addKyc');
        Route::post('get_kyc', 'PassportAuthController@getKyc');

        Route::get('get_plans', 'PassportAuthController@plans');
        Route::get('get_user_by_refferal', 'PassportAuthController@getUserByRefferal');
        Route::get('get_cities', 'PassportAuthController@cities');
        Route::post('my_plan', 'PassportAuthController@my_plan');
        ...
        Route::post('purchase_plan', 'SocialAuthController@purchase_plan');
        Route::post('get_referral_history', 'SocialAuthController@get_referral_history');
        Route::post('get_repurchase_history', 'SocialAuthController@get_repurchase_history');
        Route::post('get_user_wallet', 'SocialAuthController@get_user_wallet');
        Route::get('get_zipcode', 'SocialAuthController@get_zipcode');
        Route::post('withdrawal_request', 'SocialAuthController@withdrawal_request');
        Route::post('get_withdrawal_request', 'SocialAuthController@get_withdrawal_request');
        Route::get('daily_bonus', 'SocialAuthController@daily_bonus');
        Route::post('my_team', 'SocialAuthController@myTeam');
        Route::post('get_user_by_referral', 'SocialAuthController@getUserByReferral');
        Route::post('fund_request', 'SocialAuthController@fundRequest');
        Route::post('get_fund_request', 'SocialAuthController@getFundRequest');
        Route::post('send_money', 'SocialAuthController@sendMoney');

        Route::get('test_mode', 'SocialAuthController@gettest');
        Route::get('generate_invoice/{booking_id}', 'SocialAuthController@generateInvoice');
    });
    ...
    Route::post('get_referral_bonus', 'DealController@get_bonus_referral');

    // Route::group(['prefix' => 'products','middleware'=>'auth:api'], function () {

    Route::group(['prefix' => 'products'], function () {
        Route::get('latest', 'ProductController@get_latest_products');
        Route::get('all-products', 'ProductController@get_all_products');
    ...
    Route::group(['prefix' => 'service-categories', 'middleware' => 'auth:api'], function () {
        Route::get('/', 'CategoryController@get_servicecategories');
        // Route::get('products/{category_id}', 'CategoryController@get_products');
    });
    ...
    Route::group(['prefix' => 'customer', 'middleware' => 'auth:api'], function () {
        ...
        Route::group(['prefix' => 'booking'], function () {
            Route::post('doctor_appointment', 'CustomerController@doctorAppointment');
            Route::post('homevisit_appointment', 'CustomerController@homevisitAppointment');
            Route::get('get_services/{id}', 'CustomerController@getServices');
            Route::post('get_timeslots', 'CustomerController@getTimeSlot');
            Route::post('reschedule_booking', 'CustomerController@rescheduleBooking');
            Route::post('services-booking', 'CustomerController@bookingServices');
            Route::get('my-booking', 'CustomerController@myBookingServices');
        });
        ...
        Route::group(['prefix' => 'order'], function () {
            ...
            Route::post('payment-option', 'OrderController@payment_option');
            ...
            Route::get('generate-invoice/{id}', 'CustomerController@generate_invoice');
            Route::get('re-order/{orderid}', 'CustomerController@reOrder');
        });
        // Chatting
