...
Route::group(['namespace' => 'Seller', 'prefix' => 'seller', 'as' => 'seller.'], function () {
    ...
    Route::group(['middleware' => ['seller']], function () {
        ...
        Route::group(['prefix' => 'service', 'as' => 'service.'], function () {
            Route::get('list/{type}', 'SellerServiceController@list')->name('list');
            Route::get('categorylist', 'SellerServiceController@category_list')->name('categorylist');
            Route::get('add-new', 'SellerServiceController@add_new')->name('add-new');
            Route::get('single-service-view/{id}', 'SellerServiceController@single_service_view')->name('single-service-view');
            Route::post('add-new-service', 'SellerServiceController@add_new_service')->name('add-new-service');
            Route::get('edit-service-view/{id}', 'SellerServiceController@edit_service_view')->name('edit-service-view');
            Route::post('update-service/{id}', 'SellerServiceController@update_service')->name('update-service');
            Route::post('storeTimeSlotes', 'SellerServiceController@storeTimeSlotes')->name('storeTimeSlotes');
            Route::post('updateTimeSlotes', 'SellerServiceController@updateTimeSlotes')->name('updateTimeSlotes');
            Route::delete('slotdelete/{id}', 'SellerServiceController@slotdelete')->name('slotdelete');
        });
        ...
        Route::group(['prefix' => 'plan', 'as' => 'plan.',], function () {
            Route::get('plan-list', 'PlanController@plan_list')->name('plan-list');
            Route::post('purchase_plan', 'PlanController@purchase_plan')->name('purchase_plan');
            Route::post('track-plan-status', 'PlanController@track_plan_status')->name('track-plan-status');
        ...
        Route::group(['prefix' => 'shop', 'as' => 'shop.'], function () {
            ...
            Route::get('seller_certificate/{id}', 'ShopController@sellerCertificate')->name('certificates');
        ...
        Route::group(['prefix' => 'withdraw', 'as' => 'withdraw.'], function () {
            ...
            Route::post('bonusrequest', 'WithdrawController@bonusrequest')->name('bonusrequest');
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.'], function () {
            ...
            Route::group(['prefix' => 'bonus', 'as' => 'bonus.'], function () {
                Route::get('bonus_list', 'WithdrawController@bonusList')->name('list');
                // Route::get('cancel/{id}', 'WithdrawController@close_request')->name('cancel');
                // Route::post('status-filter', 'WithdrawController@status_filter')->name('status-filter');
            });
