...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['prefix' => 'shop', 'as' => 'shop.', 'namespace' => 'Auth'], function () {
        Route::get('apply', 'RegisterController@create')->name('apply');
        Route::get('getSellers', 'RegisterController@getSellers');
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'dashboard', 'as' => 'dashboard.'], function () {
            ...
            Route::post('withdrawal_request', 'DashboardController@withdrawal_request')->name('withdrawal_request');
            Route::get('method-list', 'DashboardController@method_list')->name('method-list');
            Route::get('bonus_list', 'DashboardController@bonusList')->name('bonus_list');
            Route::get('my_kyc', 'DashboardController@myKyc')->name('my_kyc');
            Route::post('update_kyc', 'DashboardController@updateKyc')->name('update_kyc');
        });
        //system routes
        ...
        Route::group(['prefix' => 'deal', 'as' => 'deal.', 'middleware' => ['module:promotion_management']], function () {
            ...
            Route::post('update-product-status', 'DealController@updateProductStatus')->name('update-product-status');
        ...
        //     Route::get('add-new-district', 'EmployeeController@add_new_district')->name('add-new-district');
        //     Route::get('add-new-state', 'EmployeeController@add_new_state')->name('add-new-state');
        //     Route::post('add-new', 'EmployeeController@store');
        //     Route::get('add-new-doctor', 'EmployeeController@add_new_doctor')->name('add-new-doctor');
        //     Route::post('add-new-doctor', 'EmployeeController@doctor_store');
        //     Route::get('doctor_list', 'EmployeeController@doctor_list')->name('doctor_list');
        //     Route::post('add-new-district', 'EmployeeController@districtstore');
        //     Route::post('add-new-state', 'EmployeeController@statestore');
        //     Route::post('get_referral', 'EmployeeController@getReferral');
        //     Route::get('list', 'EmployeeController@list')->name('list');
        //     Route::get('district_list', 'EmployeeController@district_list')->name('district_list');
        //     Route::get('state_list', 'EmployeeController@state_list')->name('state_list');
        //     Route::get('withdrawal_list', 'EmployeeController@withdrawal_list')->name('withdrawal_list');
        //     Route::get('kyc_list', 'EmployeeController@kyc_list')->name('kyc_list');
        //     Route::get('update/{id}', 'EmployeeController@edit')->name('update');
        //     Route::post('update/{id}', 'EmployeeController@update');
        //     Route::post('status', 'EmployeeController@status')->name('status');
        // });

        Route::group(['prefix' => 'panel', 'as' => 'employee.'], function () {
            Route::get('add-new-admin', 'EmployeeController@add_new')->name('add-new');
            Route::get('add-new-aggregator', 'EmployeeController@add_new_district')->name('add-new-district');
            Route::get('add-new-home-checkup', 'EmployeeController@add_new_state')->name('add-new-state');
            Route::post('add-new-admin', 'EmployeeController@store');
            Route::get('add-new-doctor', 'EmployeeController@add_new_doctor')->name('add-new-doctor');
            Route::post('add-new-doctor', 'EmployeeController@doctor_store');
            Route::get('doctor_list', 'EmployeeController@doctor_list')->name('doctor_list');
            Route::post('add-new-aggregator', 'EmployeeController@districtstore');
            Route::post('add-new-home-checkup', 'EmployeeController@statestore');
            Route::post('get_referral', 'EmployeeController@getReferral');
            Route::get('admin-list', 'EmployeeController@list')->name('list');
            Route::get('aggregator_list', 'EmployeeController@district_list')->name('district_list');
            Route::get('home-checkup-list', 'EmployeeController@state_list')->name('state_list');
            Route::get('withdrawal_list', 'EmployeeController@withdrawal_list')->name('withdrawal_list');
            Route::get('kyc_list', 'EmployeeController@kyc_list')->name('kyc_list');
            Route::get('edit-doctor/{id}', 'EmployeeController@edit_doctor')->name('edit-doctor');
            Route::post('update-doctor/{id}', 'EmployeeController@update_doctor')->name('update-doctor');
            Route::get('update/{id}', 'EmployeeController@edit')->name('update');
            Route::post('update/{id}', 'EmployeeController@update');
            Route::post('status', 'EmployeeController@status')->name('status');
        });
        ...
        Route::group(['prefix' => 'servicecategory', 'as' => 'servicecategory.', 'middleware' => ['module:product_management']], function () {
            Route::get('view', 'ServiceCategoryController@index')->name('view');
            Route::get('fetch', 'ServiceCategoryController@fetch')->name('fetch');
            Route::post('store', 'ServiceCategoryController@store')->name('store');
            Route::get('edit/{id}', 'ServiceCategoryController@edit')->name('edit');
            Route::post('update/{id}', 'ServiceCategoryController@update')->name('update');
            Route::post('delete', 'ServiceCategoryController@delete')->name('delete');
            Route::post('status', 'ServiceCategoryController@status')->name('status');
        });


        // Route::group(['prefix' => 'appointment', 'as' => 'appointment.', 'middleware' => ['module:appointment']], function () {
        ...
        //     Route::post('delete', 'AppointmentController@delete')->name('delete');
        //     // Route::post('status', 'AppointmentController@status')->name('status');
        // });
        ...
        Route::group(['prefix' => 'plan', 'as' => 'plan.',], function () {
            Route::get('add-new', 'PlanController@add_new')->name('add-new');
            Route::post('store-plan', 'PlanController@store')->name('store-plan');
            Route::post('store-level', 'PlanController@storelevel')->name('store-level');
            Route::get('update/{id}', 'PlanController@edit')->name('update');
            Route::get('plantransactions', 'PlanController@plantransactions')->name('plantransactions');
            Route::get('my_withdrawal_list', 'PlanController@my_withdrawal_list')->name('my_withdrawal_list');
            Route::get('user_referral_transactions', 'PlanController@userReferralTransactions')->name('user_referraltransactions');
            Route::get('user_daily_bonus_transactions', 'PlanController@userDailyTransactions')->name('user_dailytransactions');
            Route::get('repurchasetransactions', 'PlanController@repurchaseTransactions')->name('repurchasetransactions');
            Route::get('tds_transactions', 'PlanController@tdsTransactions')->name('tdsTransactions');
            Route::post('update/{id}', 'PlanController@update');
            Route::post('level_update', 'PlanController@levelupdate')->name('level_update');
            Route::get('quick-view-details', 'PlanController@quick_view_details')->name('quick-view-details');
            Route::get('status/{id}/{status}', 'PlanController@status')->name('status');
            Route::get('userstatus/{id}', 'PlanController@userstatus')->name('userstatus');
            Route::get('frenchisestatus/{id}', 'PlanController@frenchisestatus')->name('frenchisestatus');
            Route::get('kycstatus/{id}/{status}', 'PlanController@kycstatus');
            Route::delete('delete/{id}', 'PlanController@delete')->name('delete');
            Route::get('delete-level/{id}', 'PlanController@deletelevel')->name('delete-level');
            Route::post('ajax-get-seller', 'PlanController@ajax_get_seller')->name('ajax-get-seller');
        });
        ...
        Route::group(['prefix' => 'customer', 'as' => 'customer.', 'middleware' => ['module:user_section']], function () {
            ...
            Route::get('certificate/{user_id}', 'CustomerController@certificate')->name('certificate');
            Route::get('kycstatus/{user_id}/{status}', 'CustomerController@kycstatus');
            ...
            Route::get('withdrawal_list', 'CustomerController@withdrawal_list')->name('withdrawal_list');
            Route::get('fund_list', 'CustomerController@fund_list')->name('fund_list');
            Route::post('update_fund_list', 'CustomerController@updatefund')->name('update_fund_list');
            Route::post('add_money', 'CustomerController@addMoney')->name('add_money');

            Route::get('edit/{user_id}', 'CustomerController@edit')->name('edit');
            Route::post('update/{user_id}', 'CustomerController@update')->name('update');
            Route::put('update/{user_id}', 'CustomerController@update')->name('admin.customer.update');
        ...
        Route::group(['prefix' => 'refund-section', 'as' => 'refund-section.', 'middleware' => ['module:order_management']], function () {
            ...
            Route::group(['prefix' => 'refund', 'as' => 'refund.'], function () {
                ...
                Route::get('seller-list', 'RefundController@sellerList')->name('seller');
        ...
        Route::group(['prefix' => 'sellers', 'as' => 'sellers.', 'middleware' => ['module:user_section']], function () {
            ...
            Route::get('service-seller-list', 'SellerController@service_index')->name('service-seller-list');
            Route::get('both-seller-list', 'SellerController@both_index')->name('both-seller-list');
            ...
            Route::get('certificate/{id}', 'SellerController@sellerCertificate')->name('certificate');
            Route::post('update-status', 'SellerController@updateStatus')->name('updateStatus');
            Route::post('update-wallet', 'SellerController@updateWallet')->name('updateSallet');
            ...
            Route::get('fund_request', 'SellerController@fundRequest')->name('fund_request');
            Route::post('update_fund_request', 'SellerController@updatefundRequest')->name('update_fund_request');
        ...
        Route::group(['prefix' => 'service', 'as' => 'service.', 'middleware' => ['module:service_management']], function () {
            ...
            Route::get('export-excel/{type}', 'ServiceController@export_excel')->name('export-excel');
            Route::get('stock-limit-list/{type}', 'ServiceController@stock_limit_list')->name('stock-limit-list');
            ...
            Route::post('featured-status', 'ServiceController@featured_status')->name('featured-status');
            Route::get('approve-status', 'ServiceController@approve_status')->name('approve-status');
            Route::post('deny', 'ServiceController@deny')->name('deny');
            ...
            Route::get('updated-product-list', 'ServiceController@updated_product_list')->name('updated-product-list');
            Route::post('updated-shipping', 'ServiceController@updated_shipping')->name('updated-shipping');
            ...
            Route::get('bulk-export', 'ServiceController@bulk_export_data')->name('bulk-export');
            Route::get('barcode/{id}', 'ServiceController@barcode')->name('barcode');
            Route::get('barcode/generate', 'ServiceController@barcode_generate')->name('barcode.generate');
        });
        ...
        Route::group(['prefix' => 'orders', 'as' => 'orders.', 'middleware' => ['module:order_management']], function () {
            ...
            Route::post('add-warehouse', 'OrderController@add_warehouse')->name('add_warehouse');
            Route::get('add-delivery-man/{order_id}/{d_man_id}/{type}', 'OrderController@add_delivery_man')->name('add-delivery-man');

            Route::get('export-order-data/{status}', 'OrderController@bulk_export_data')->name('order-bulk-export');
        });
        Route::group(['prefix' => 'bookings', 'as' => 'bookings.', 'middleware' => ['module:appointment']], function () {
            Route::get('list/service-list', 'BookingController@serviceList')->name('doctorAppointment');
            Route::get('list/home-visit-appointment', 'BookingController@homevisitAppointments')->name('homevisitAppointment');
            Route::get('details/{id}', 'BookingController@appointmentDetails')->name('details');
            Route::post('status', 'BookingController@bookingStatus')->name('status');
            Route::get('add-doctor/{order_id}/{d_man_id}/{type}', 'BookingController@assignBooking')->name('assign-doctor');
            Route::post('payment-status', 'BookingController@payment_status')->name('payment-status');
            // Route::post('amount-date-update', 'OrderController@amount_date_update')->name('amount-date-update');
            // Route::post('productStatus', 'OrderController@productStatus')->name('productStatus');
            // Route::get('generate-invoice/{id}', 'OrderController@generate_invoice')->name('generate-invoice')->withoutMiddleware(['module:order_management']);
            // Route::get('inhouse-order-filter', 'OrderController@inhouse_order_filter')->name('inhouse-order-filter');
