...
class ServiceManager
{
    ...
    public static function get_latest_products_by_zipcode($limit = 10, $offset = 1,$zipcode)
    {
    ...
    public static function get_featured_products_by_zipcode($limit = 10, $offset = 1, $zipcode)
    {
