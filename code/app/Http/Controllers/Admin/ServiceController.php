...
class ServiceController extends BaseController
{
    public function add_new()
    {
        ...
        return view('admin-views.service.add-new', compact('cat', 'br', 'brand_setting', 'digital_product_setting'));
    }
    ...
    public function approve_status(Request $request)
    {
        ...
        return redirect()->route('admin.service.list', ['seller', 'status' => $product['request_status']]);
    }
    ...
    public function deny(Request $request)
    {
        ...
        return redirect()->route('admin.service.list', ['seller', 'status' => 2]);
    }
    ...
    public function view($id)
    {
        ...
        return view('admin-views.service.view', compact('product', 'reviews'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return redirect()->route('admin.service.list', ['in_house']);
        }
    }
    ...
    function list(Request $request, $type)
    {
        ...
        if ($type == 'in_house') {
            $pro = Service::with('seller','category','booking')->withCount('booking')->where(['added_by' => 'seller']);
        } else {
            $pro = Service::with('seller','category','booking')->withCount('booking')->where(['added_by' => 'seller'])->where('request_status', $request->status);
        }
        ...
        // dd($pro);
        return view('admin-views.service.list', compact('pro', 'search', 'request_status', 'type'));
    }
    ...
    public function updated_product_list(Request $request)
    {
        ...
        return view('admin-views.service.updated-product-list', compact('pro', 'search'));
    }
    ...
    public function stock_limit_list(Request $request, $type)
    {
        ...
        $pro = $pro->orderBy('id', 'DESC')->paginate(Helpers::pagination_limit())->appends(['status' => $request['status']])->appends($query_param);
        return view('admin-views.service.stock-limit-list', compact('pro', 'search', 'request_status', 'sort_oqrderQty', 'stock_limit'));
    }
    ...
    public function sku_combination(Request $request)
    {
        ...
        $combinations = Helpers::combinations($options);
        return response()->json([
            'view' => view('admin-views.service.partials._sku_combinations', compact('combinations', 'unit_price', 'colors_active', 'product_name'))->render(),
        ]);
    }
    ...
    public function get_variations(Request $request)
    {
        $product = Product::find($request['id']);
        return response()->json([
            'view' => view('admin-views.service.partials._update_stock', compact('product'))->render()
        ]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin-views.service.edit', compact('categories', 'br', 'product', 'product_category','brand_setting','digital_product_setting'));
    }
