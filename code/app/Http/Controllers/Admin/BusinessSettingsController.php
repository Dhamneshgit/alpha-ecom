...
class BusinessSettingsController extends Controller
{
    ...
    public function companyInfo()
    {
        ...
        $signup_bonus = BusinessSetting::where('type', 'signup_bonus')->first();
        $repurchase_income = BusinessSetting::where('type', 'repurchase_income')->first();
        $admin_commission_customer = BusinessSetting::where('type', 'admin_commission_customer')->first();
        $tds_customer = BusinessSetting::where('type', 'tds_customer')->first();
        $tds_frenchise = BusinessSetting::where('type', 'tds_frenchise')->first();
        $admin_commission_frenchise = BusinessSetting::where('type', 'admin_commission_frenchise')->first();
        $team_level_income = BusinessSetting::where('type', 'team_level_income')->first();
        $minimum_seller_wallet = BusinessSetting::where('type', 'minimum_seller_wallet')->first();
        ...
        return view('admin-views.business-settings.website-info', [
            ...
            'admin_commission_customer' => $admin_commission_customer,
            'tds_customer' => $tds_customer,
            'tds_frenchise' => $tds_frenchise,
            'admin_commission_frenchise' => $admin_commission_frenchise,
            'team_level_income' => $team_level_income,
            'minimum_seller_wallet' => $minimum_seller_wallet,
        ]);
    }
    ...
    public function updateInfo(Request $request)
    {
        ...
        //sign up bonus
        DB::table('business_settings')->updateOrInsert(['type' => 'signup_bonus'], [
            'value' => $request['signup_bonus']
        ]);

        //withdrawal bonus
        DB::table('business_settings')->updateOrInsert(['type' => 'repurchase_income'], [
            'value' => $request['repurchase_income']
        ]);

        DB::table('business_settings')->updateOrInsert(['type' => 'team_level_income'], [
            'value' => $request['team_level_income']
        ]);

        DB::table('business_settings')->updateOrInsert(['type' => 'admin_commission_frenchise'], [
            'value' => $request['admin_commission_frenchise']
        ]);

        DB::table('business_settings')->updateOrInsert(['type' => 'tds_frenchise'], [
            'value' => $request['tds_frenchise']
        ]);

        DB::table('business_settings')->updateOrInsert(['type' => 'admin_commission_customer'], [
            'value' => $request['admin_commission_customer']
        ]);

        DB::table('business_settings')->updateOrInsert(['type' => 'tds_customer'], [
            'value' => $request['tds_customer']
        ]);
        DB::table('business_settings')->updateOrInsert(['type' => 'minimum_seller_wallet'], [
            'value' => $request['minimum_seller_wallet']
        ]);
    ...
    public function otp_setup()
    {
        ...
        return view('admin-views.business-settings.otp-setup', compact(
            'maximum_otp_hit',
            'otp_resend_time',
