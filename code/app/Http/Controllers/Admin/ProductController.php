...
class ProductController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        $p->qty_step_size     = $request->qty_step_size;
    ...
    public function bulk_import_data(Request $request)
    {
        ...
        $col_key = ['name', 'category_id', 'sub_category_id', 'sub_sub_category_id', 'unit', 'min_qty', 'refundable', 'youtube_video_url', 'unit_price', 'purchase_price', 'tax', 'discount', 'discount_type', 'current_stock', 'details', 'thumbnail'];
