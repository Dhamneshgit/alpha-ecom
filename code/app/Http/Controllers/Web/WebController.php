...
class WebController extends Controller
{
    ...
    public function flash_deals($id = null)
    {
        ...
        $discountPrice = FlashDealProduct::with(['product'])->where('status', 1)->whereHas('product', function ($query) {
            $query->active();
    ...
    {
        $brands = ServiceCategory::paginate(24);
        // dd($brands);
        return view('web-views.service_category', compact('brands'));
    }
