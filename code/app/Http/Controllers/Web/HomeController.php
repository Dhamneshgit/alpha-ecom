...
class HomeController extends Controller
{
    ...
    public function updateCitySession(Request $request)
    {
    ...
    public function deleteAccount(Request $request)
    {
        ...
        if ($check) {
            $check = User::where('phone', $mobile)->delete();
            // $this->session->set_flashdata("success", "Delete account successfully");
            return back()->with('success', 'Delete account successfully');
        } else {
            return back()->with('error', 'Incorrect Mobile number');
        }
    }
    ...
    public function default_theme()
    {
        ...
        $return_orders_count = Order::where('order_status', 'Returned')
        ...
        // return view(VIEW_FILE_NAMES['index']);
    }
