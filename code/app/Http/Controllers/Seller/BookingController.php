...
class BookingController extends Controller
{
    ...
    public function appointmentDetails($id)
    {
        ...
        $order = Booking::with('seller.shop','user')->where('seller_id',$currentUserId)->where(['id' => $id])->first();
        ...
        // if ($order->order_type == 'default_type') {
            return view('seller-views.booking.order-details', compact(
                'manufacturer',
                'aggregator',
                'doctor',
                'homevisit',
