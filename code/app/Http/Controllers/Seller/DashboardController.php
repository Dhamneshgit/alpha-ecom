...
class DashboardController extends Controller
{
    public function dashboard()
    {
        ...
        $sellerData = Seller::find(auth('seller')->id());
        $data['earning_wallet'] = $sellerData->earning_wallet;
        $data['wallet_maintain'] = $sellerData->wallet_maintain;
        ...
        return view('seller-views.system.dashboard', compact('data', 'seller_data', 'commission_data', 'withdrawal_methods', 'sellerData'));
    }
