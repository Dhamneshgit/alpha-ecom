...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'qty_step_size'        => 'required|numeric|min:1',
            ...
            'qty_step_size.required'           => 'Quantity step size is required!',
            'qty_step_size.min'                => 'Quantity step size must be positive!',
        ...
        $product->qty_step_size     = $request->qty_step_size;
    ...
    public function sku_combination(Request $request)
    {
        ...
        return response()->json([
            ...
            'view' => view('admin-views.product.partials._sku_combinations', compact('combinations', 'unit_price', 'product_name'))->render(),
        ]);
    }
    ...
    public function bulk_import_data(Request $request)
    {
        ...
        $col_key = ['name', 'category_id', 'sub_category_id', 'unit', 'min_qty', 'refundable', 'youtube_video_url', 'unit_price', 'purchase_price', 'tax', 'discount', 'discount_type', 'current_stock', 'details', 'thumbnail'];
