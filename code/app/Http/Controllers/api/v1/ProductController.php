...
class ProductController extends Controller
{
    public function get_latest_products(Request $request)
    {
        ...
        $products = ProductManager::get_latest_products($request['limit'], $request['offset'], $zipcode);
    ...
    public function get_featured_products(Request $request)
    {
        ...
        $products = ProductManager::get_featured_products_by_zipcode($request['limit'], $request['offset'], $zipcode);
        $products['products'] = Helpers::product_data_formatting($products['products'], true);
        return response()->json($products, 200);
    }
    ...
    public function get_all_products(Request $request)
    {
        ...
        $products = Product::orderBy('id', 'DESC')->paginate(Helpers::pagination_limit());

        // // Format the product data
        $products['products'] = Helpers::product_data_formatting($products->items(), true);
    ...
    public function get_product($slug)
    {
        ...
        if (isset($product)) {
            ...
            $product['related_products'] = Product::where('name', $product->name)
