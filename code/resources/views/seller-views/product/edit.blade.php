                                ...
                                <div class="{{$lang != 'en'? 'd-none':''}} lang_form" id="{{$lang}}-form">
                                    ...
                                    <div class="form-group pt-4">
                                        <label class="title-color"
                                            ...
                                            ({{ strtoupper($lang) }})</label>
                                        <textarea name="description" id="editor12343">{!! $translate[$lang]['description']??$product['details'] !!}</textarea>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-2 form-group mb-3">
                                        ...
                                        <select name="tax_model" class="form-control" >
                        ...
                        <div class="card-body">
                            <div class="row">
                                <!-- <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" value="{{$product['video_url']}}" name="video_link" placeholder="EX : https://www.youtube.com/embed/5R06LRdUCSE" class="form-control" >
                                </div> -->
                            ...
                            <div class="col-12 d-flex justify-content-end mt-3">
                                @if($product['request_status'] == 2)
                                    <button type="submit" class="btn btn--primary px-4">{{ \App\CPU\translate('resubmit') }}</button>
                                @else
