...
@section('content')
{{-- <style>
    .double-editor .ck.ck-reset.ck-editor.ck-rounded-corners:nth-child(3) {
    display: none !important;
}

.double-editor .ck.ck-reset.ck-editor.ck-rounded-corners .ck.ck-content {
    height: 250px;
}
</style> --}}
{{-- <style>
                            ...
                            @foreach (json_decode($language) as $lang)
                                <div class="{{ $lang != $default_lang ? 'd-none' : '' }} lang_form"
                                    ...
                                    <div class="form-group pt-4">
                                        ...
                                        <textarea name="description" id="editor12343">{{ old('details') }}</textarea>
                                    </div>
                                </div>
                            @endforeach
                        </div>
...
@push('script')
    ...
    <script>
        ...
        $(document).on('submit','#product_form', function(e) {
            ...
            Swal.fire({
                ...
                // }
                // if (CKEDITOR.instances['editor12343']) {
                //     CKEDITOR.instances['editor12343'].updateElement();
                // }
                var formData = new FormData(this);

                // formData.append('description', $('#editor12343').val());
    ...
    <script>
        ...
        //             language: '{{ Session::get('direction') }}'
