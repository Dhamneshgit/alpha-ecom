            ...
            <div class="card">
                <div class="card-body text-capitalize d-flex flex-column gap-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="choose_delivery_man mt-3 d-none">
                            <label class="font-weight-bold title-color fz-14">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <form action="{{ route('seller.orders.add_warehouse') }}" method="POST">
                                                @csrf
                                                <input type="hidden" name="seller_id" value="{{ $order->seller->id }}">
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="">{{ \App\CPU\translate('Phone') }}</label>
                                                        <input class="form-control" type="number" name="phone" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="">{{ \App\CPU\translate('alternate_phone') }}</label>
                                                        <input class="form-control" type="number" name="alternate_phone" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="">{{ \App\CPU\translate('address_title') }}</label>
                                                        <input class="form-control" type="text" name="address_title" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="">{{ \App\CPU\translate('address_line_one') }}</label>
                                                        <input class="form-control" type="text" name="address_line_one" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="">{{ \App\CPU\translate('address_line_two') }}</label>
                                                        <input class="form-control" type="text" name="address_line_two" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="">{{ \App\CPU\translate('pincode') }}</label>
                                                        <input class="form-control" type="text" name="pin_code" required>
                                                    </div>
...
<script>
    function initializegLocationMap() {
        ...
        google.maps.event.addListener(marker, 'click', (function(marker) {
            return function() {
                infowindow.setContent("<div style='float:left'><img style='max-height:40px;wide:auto;' src='{{asset('storage/app/public/profile/')}}{{$order->customer->image??"
