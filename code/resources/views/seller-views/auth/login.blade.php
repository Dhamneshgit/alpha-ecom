                    ...
                    <div class="card-body">
                        ...
                        <form id="form-id"  action="{{route('seller.auth.login')}}" method="post">
                            ...
                            <div class="js-form-message form-group">
                                <label class="input-label" for="signinSrEmail">{{\App\CPU\translate('mobile_number')}}</label>

                                <input type="text" class="form-control form-control-lg" name="phone" 
                                    placeholder="mobile number" aria-label="email@address.com"
                        ...
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-12 d-flex flex-wrap justify-content-around justify-content-md-between align-items-center __gap-15"
                                    ...
                                    <div class="{{ Session::get('direction') === 'rtl' ? 'ml-2' : '' }}">
                                        <a class="btn btn-outline-primary" href="{{ route('shop.apply') }}">
