            ...
            <div class="flex-between row align-items-center mx-1">
                <div>
                    ...
                    <div class="d-flex gap-2">
                        <p>{{ \App\CPU\translate('Welcome')}}</p>
                        <p>{{$sellerData->f_name}}.</p>    
                    </div>
                </div>
        ...
        <div class="modal fade" id="bonus-modal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content"
                    ...
                    <form action="{{route('seller.withdraw.bonusrequest')}}" method="post">
                        <div class="modal-body">
                            @csrf
                            <div class="">
                                <select class="form-control" id="withdraw_method" name="withdraw_method" required>
                            ...
                            <div class="mt-1">
                                <label for="recipient-name" class="col-form-label fz-16">{{\App\CPU\translate('Amount')}}
                                    :</label>
                                <input type="number" name="amount" step=".01"
                                       value="{{\App\CPU\BackEndHelper::usd_to_currency($data['earning_wallet'])}}"
                                       class="form-control" id="">
                            </div>
                        </div>
                        <div class="modal-footer">
