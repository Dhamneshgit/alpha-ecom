                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-8 mt-3 mt-lg-0 d-flex flex-wrap gap-3 justify-content-lg-end">
                                ...
                                @if (!isset($request_status))
                                    <a href="{{ route('seller.service.add-new') }}" class="btn btn--primary">
                                        <i class="tio-add"></i>
                                        <span class="text">{{ \App\CPU\translate('Add_New_Service') }}</span>
                                    </a>
                                @endif
                            </div>
                        </div>
                            ...
                            <tbody>
                                @foreach ($pro as $k => $p)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('seller.service.single-service-view', [$p['id']]) }}"
                                        ...
                                        <td class="text-right">
                                            <b>{{ $p->seller['f_name'] . ' ' . $p->seller['l_name'] }}</b>
                                            <br>
                                            <b>{{ $p->seller['phone'] }}</b>
                                        </td>
                                        <td class="text-right">
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center gap-2">
                                                <a class="d-none btn btn-outline-info btn-sm square-btn"
                                                ...
                                                <a class="btn btn-outline-info btn-sm square-btn" title="View"
                                                    href="{{ route('seller.service.single-service-view', [$p['id']]) }}">
                                                    <i class="tio-invisible"></i>
                                                </a>
                                                <a class="btn btn-outline--primary btn-sm square-btn"
                                                    title="{{ \App\CPU\translate('Edit') }}"
                                                    href="{{ route('seller.service.edit-service-view', [$p['id']]) }}">
                                                    <i class="tio-edit"></i>
                                                </a>
                                                <a class="d-none btn btn-outline-danger btn-sm square-btn"
