                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="d-inline-flex gap-2">
                            <button class="btn btn-block __inline-70 d-none" data-toggle="modal" data-target="#balance-modal">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center flex-wrap gap-5">
                            ...
                            <a href="{{route('seller.shop.certificates',$shop->seller_id)}}" class="btn btn-primary d-none" target="_blank"><button>Download Certificate</button></a>
                            <div class=""></div>
                        </div>
                    </div>
                </div>
