                    ...
                    <form action="{{route('seller.shop.update',[$shop->id])}}" method="post"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="name" class="title-color">{{\App\CPU\translate('Contact')}} 
                                        <!-- <span class="text-info">( * {{\App\CPU\translate('country_code_is_must')}} {{\App\CPU\translate('like_for_BD_880')}} )</span> -->
                                    </label>
                                    <input type="text" name="contact" value="{{$shop->contact}}" class="form-control" id="name" maxlength="10" required>
                                </div>
                                <div class="form-group">
