                            ...
                            <div class="d-flex flex-column gap-10">
                                ...
                                <div class="d-flex flex-wrap gap-10">
                                    <div
                                        ...
                                        {{ \App\CPU\translate('linked_orders') }} ({{ $linked_orders->count() }}) :
                                    </div>
            ...
            <div class="col-lg-4 col-xl-3 d-flex flex-column gap-3">
                <div class="card">
                    <div class="card-body text-capitalize d-flex flex-column gap-4">
                        ...
                        @if ($physical_product)
                            @if (auth('admin')->user()->role->name == 'Master Admin')
                            ...
                            @elseif(auth('admin')->user()->role->name == 'Manufacturer')
                            ...
                            <ul class="list-unstyled list-unstyled-py-4 d-none">
                                ...
                                <li class="choose_delivery_man d-none">
                                    <label class="font-weight-bold title-color fz-14">
                                    ...
                                    <input type="number" id="deliveryman_charge" onkeyup="amountDateUpdate(this, event)"
                                        value="0" name="deliveryman_charge" class="form-control"
                                        placeholder="Ex: 20">
                                </li>
                                <li class="choose_delivery_man">
                                    <label class="font-weight-bold title-color fz-14">
                    ...
                    <div class="card-body">
                        ...
                        <div class="media">
                            @if ($order->seller_is == 'admin')
                                ...
                                <div class="media-body d-flex flex-column gap-2">
                                    <h5>Warehouse ID : </h5>
                                    <span class="title-color"><strong>{{ $order->seller->warehouse_id }}</strong></span>
                                </div>
                            @else
                                @if (!empty($order->seller->shop))
                                    ...
                                    <div class="media-body d-flex flex-column gap-2">
                                        ...
                                        <div class="d-flex align-items-start gap-2">
                                            <h5>Warehouse ID : </h5>
                                            <span
                                                class="title-color"><strong>{{ $order->seller->warehouse_id }}</strong></span>
                                        </div>
                                    </div>
                                @else
                                    <div class="card-body">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-12">
                                                <form action="{{ route('admin.orders.add_warehouse') }}" method="POST">
                                                    @csrf
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            <label
                                                                for="">{{ \App\CPU\translate('Name') }}</label>
                                                            <input class="form-control" type="text" name="name"
                                                                required>
                                                        </div>
                                                        <div class="form-group">
                                                            <label
                                                                for="">{{ \App\CPU\translate('Email') }}</label>
                                                            <input class="form-control" type="email" name="email"
                                                                required>
                                                        </div>
                                                        <div class="form-group">
                                                            <label
                                                                for="">{{ \App\CPU\translate('Phone') }}</label>
                                                            <input class="form-control" type="number" name="phone"
                                                                required>
                                                        </div>
                                                        <div class="form-group">
                                                            <label
                                                                for="">{{ \App\CPU\translate('alternate_phone') }}</label>
                                                            <input class="form-control" type="number"
                                                                name="alternate_phone" required>
                                                        </div>
                                                        <div class="form-group">
                                                            <label
                                                                for="">{{ \App\CPU\translate('address_title') }}</label>
                                                            <input class="form-control" type="text"
                                                                name="address_title" required>
                                                        </div>
                                                        <div class="form-group">
                                                            <label
                                                                for="">{{ \App\CPU\translate('address_line_one') }}</label>
                                                            <input class="form-control" type="text"
                                                                name="address_line_one" required>
                                                        </div>
                                                        <div class="form-group">
                                                            <label
                                                                for="">{{ \App\CPU\translate('address_line_two') }}</label>
                                                            <input class="form-control" type="text"
                                                                name="address_line_two" required>
                                                        </div>
                                                        <div class="form-group">
                                                            <label
                                                                for="">{{ \App\CPU\translate('pincode') }}</label>
                                                            <input class="form-control" type="text" name="pin_code"
                                                                required>
                                                        </div>

                                                        <button class="btn btn--primary"
                                                            type="submit">{{ \App\CPU\translate('update') }}
                                                        </button>
                                                    </div>
                                                </form>
                                            </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form action="{{ route('admin.orders.update-deliver-info') }}" method="POST">
                                ...
                                <div class="card-body">
                                    <input type="hidden" name="itemweight_id" value="{{ $itemWeight->id ?? '' }}">
                                    <div class="form-group">
                                        <label for="">{{ \App\CPU\translate('Length') }} (In Cm)</label>
                                        <input class="form-control" type="number" name="length"
                                            value="{{ $itemWeight->length ?? '' }}" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="">{{ \App\CPU\translate('width') }}(In Cm)</label>
                                        <input class="form-control" type="number" name="width"
                                            value="{{ $itemWeight->width ?? '' }}" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="">{{ \App\CPU\translate('height') }}(In Cm)</label>
                                        <input class="form-control" type="number" name="height"
                                            value="{{ $itemWeight->height ?? '' }}" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="">{{ \App\CPU\translate('box_weight') }}(In Kg)</label>
                                        <input class="form-control" type="text" name="weight"
                                            value="{{ $itemWeight->weight ?? '' }}" required>
                                    </div>
                                    @if (empty($itemWeight))
                                        <button class="btn btn--primary"
                                            type="submit">{{ \App\CPU\translate('update') }}</button>
                                    ...
                                    @if (!empty($itemWeight))
                                        <div class="form-group">
                                            <label
                                                for="">{{ \App\CPU\translate('delivery_service_name') }}</label>
                                            <input class="form-control" type="text" name="delivery_service_name"
                                                value="{{ $order['delivery_service_name'] }}" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="">{{ \App\CPU\translate('tracking_id') }}</label>
                                            <input class="form-control" type="text"
                                                name="third_party_delivery_tracking_id"
            ...
            @if ($order['order_status'] == 'delivered')
                Swal.fire({
                    title: '{{ \App\CPU\translate('
                                ...
                                and transaction amount has been disbursed,
                                changing status can be the reason of miscalculation ') }}!',
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.status == true) {
                        ...
                        toastr.error('Delivery man can not assign/change in that status', {
                            CloseButton: true,
                            ProgressBar: true
                        });
                    }
                ...
                google.maps.event.addListener(marker, 'click', (function(marker) {
                    return function() {
                        infowindow.setContent(
                            "<div class='float-left'><img class='__inline-5' src='{{ asset('storage/app/public/profile/') }}{{ $order->customer->image ?? '' }}'></div><div class='float-right __p-10'><b>{{ $order->customer->f_name ?? '' }} {{ $order->customer->l_name ?? '' }}</b><br/>{{ $shipping_address->address ?? '' }}</div>"
                        );
