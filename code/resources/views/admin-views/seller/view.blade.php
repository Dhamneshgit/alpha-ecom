...
<style>
    .card.h-40.d-flex.justify-content-center.align-items-center {
        padding: 12px;
    }

    .card.h-40.d-flex.justify-content-center.align-items-center .card-body.d-flex.flex-column.gap-10.align-items-center.justify-content-center {
        padding: 0;
        gap: 0;
    }
    ...
    <div class="content container-fluid">
        ...
        <div class="flex-between d-sm-flex row align-items-center justify-content-between mb-2 mx-1">
            <div>
                <a href="{{ route('admin.sellers.seller-list') }}"
                    class="btn btn--primary mt-3 mb-3">{{ \App\CPU\translate('Back_to_shop_list') }}</a>
            </div>
            <div>
        ...
        <div class="page-header">
            <div class="flex-between row mx-1">
                <div>
                    <h1 class="page-header-title">{{ $seller->shop ? $seller->shop->name : 'Shop Name : Update Please' }}
                        <span><b>({{ ucfirst($seller->type) }} Provider)</b></span>
                    </h1>
                    <h5 class="page-header-title"> Vendor Id : <span><b>{{ $seller->unique_code }}</b></span>
                    </h5>
                </div>
            </div>
            <!-- Nav Scroller -->
            <div class="js-nav-scroller hs-nav-scroller-horizontal">
                ...
                <ul class="nav nav-tabs flex-wrap page-header-tabs">
                    ...
                    <!-- <li class="nav-item d-none">
                            <a class="nav-link"
                                href="{{ route('admin.sellers.certificate', ['id' => $seller->id]) }}">{{ \App\CPU\translate('Download') }}</a>
                        </li> -->
                ...
                <div class="card-body">
                    <span class="text-danger">
                        ...
                        @elseif(
                            ...
                            <span class="text-dark"><strong>{{ \App\CPU\translate('note_from_seller') }} :</strong>
                                {{ $seller->shop->vacation_note }}</span>
                        @endif
                    </span>
                </div>
            </div>
        ...
        <div class="card mb-3 ">
            <div class="card-body">
                ...
                <div class="row justify-content-between align-items-center g-2 mb-3 d-none">
                    <div class="col-sm-6">
                        <h4 class="d-flex align-items-center text-capitalize gap-10 mb-0">
                            <img width="20" class="mb-1"
                                src="{{ asset('/public/assets/back-end/img/admin-wallet.png') }}" alt="">
                            {{ \App\CPU\translate('shop_Wallet') }}
                        </h4>
                    </div>
                </div>

                <div class="row g-2" id="order_stats">
                    <div class="col-lg-4 leftSideCardDiv">
                        <!-- Card -->
                        <div class="card h-40 d-flex justify-content-center align-items-center">
                            <div class="card-body d-flex flex-column gap-10 align-items-center justify-content-center">
                                ...
                                <h3 class="for-card-count mb-0 fz-24">
                                    {{ $seller->sellerwallet ? \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($seller->sellerwallet->total_earning)) : 0 }}
                                </h3>
                                ...
                                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <form action="{{ route('admin.sellers.updateSallet') }}" method="POST">
                                            @csrf
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Wallet Update</h5>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <label for="name"
                                                                    class="title-color text-capitalize">{{ \App\CPU\translate('Type') }}</label>
                                                                <select class="form-control" name="type">
                                                                    <option value="credit">
                                                                        {{ \App\CPU\translate('Credit') }} </option>
                                                                    <option value="debit">
                                                                        {{ \App\CPU\translate('Debit') }} </option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <label for="name"
                                                                    class="title-color text-capitalize">{{ \App\CPU\translate('Amount') }}</label>
                                                                <input class="form-control" type="nubmer" name="amount"
                                                                    required>
                                                                <input class="form-control" type="hidden"
                                                                    name="wallet_amount"
                                                                    value="{{ $seller->sellerwallet->total_earning }}"
                                                                    required>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="card h-40 d-flex justify-content-center align-items-center">
                            <div class="card-body d-flex flex-column gap-10 align-items-center justify-content-center">
                                <img width="40" class="mb-2"
                                    src="{{ asset('/public/assets/back-end/img/withdraw.png') }}" alt="">
                                <h3 class="for-card-count mb-0 fz-24">
                                    {{ $seller->sellerwallet ? \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($seller->sellerwallet->refund_amount)) : 0 }}
                                </h3>
                                <div class="font-weight-bold text-capitalize mb-30">
                                    {{ \App\CPU\translate('Total Refund balance') }}
                                </div>
                            </div>
                        </div>
                        <!-- End Card -->
                                ...
                                <div class="card card-body h-100 justify-content-center">
                                    <div class="d-flex gap-2 justify-content-between align-items-center">
                                        <div class="d-flex flex-column align-items-start">
                                            <h3 class="mb-1 fz-24">
                                                {{ $seller->sellerwallet ? \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($seller->sellerwallet->pending_withdraw)) : 0 }}
                                            </h3>
                                            <div class="text-capitalize mb-0">{{ \App\CPU\translate('Pending_Withdraw') }}
                                            </div>
                                        </div>
                                        <div>
                                            <img width="40" class="mb-2"
                            ...
                            <div class="col-md-6">
                                <div class="card card-body h-100 justify-content-center">
                                    <div class="d-flex gap-2 justify-content-between align-items-center">
                                        <div class="d-flex flex-column align-items-start">
                                            <h3 class="mb-1 fz-24">
                                                {{ $seller->sellerwallet ? \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($seller->sellerwallet->commission_given)) : 0 }}
                                            </h3>
                            ...
                            <div class="col-md-6">
                                <div class="card card-body h-100 justify-content-center">
                                    <div class="d-flex gap-2 justify-content-between align-items-center">
                                        <div class="d-flex flex-column align-items-start">
                                            <h3 class="mb-1 fz-24">
                                                {{ $seller->sellerwallet ? \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($seller->sellerwallet->withdrawn)) : 0 }}
                                            </h3>
                                            <div class="text-capitalize mb-0">{{ \App\CPU\translate('Aready_Withdrawn') }}
                                            </div>
                                        </div>
                                        <div>
                            ...
                            <div class="col-md-6">
                                <div class="card card-body h-100 justify-content-center">
                                    <div class="d-flex gap-2 justify-content-between align-items-center">
                                        <div class="d-flex flex-column align-items-start">
                                            <h3 class="mb-1 fz-24">
                                                {{ $seller->sellerwallet ? \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($seller->sellerwallet->delivery_charge_earned)) : 0 }}
                                            </h3>
                                            <div class="text-capitalize mb-0">
                            ...
                            <div class="col-md-6">
                                <div class="card card-body h-100 justify-content-center">
                                    <div class="d-flex gap-2 justify-content-between align-items-center">
                                        <div class="d-flex flex-column align-items-start">
                                            <h3 class="mb-1 fz-24">
                                                {{ $seller->sellerwallet ? \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($seller->sellerwallet->total_tax_collected)) : 0 }}
                                            </h3>
                                            <div class="text-capitalize mb-0">{{ \App\CPU\translate('total_tax_given') }}
                                            </div>
                                        </div>
                                        <div>
                            ...
                            <div class="col-md-6">
                                <div class="card card-body h-100 justify-content-center">
                                    <div class="d-flex gap-2 justify-content-between align-items-center">
                                        <div class="d-flex flex-column align-items-start">
                                            <h3 class="mb-1 fz-24">
                                                {{ $seller->sellerwallet ? \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($seller->sellerwallet->collected_cash)) : 0 }}
                                            </h3>
                                            <div class="text-capitalize mb-0">{{ \App\CPU\translate('collected_cash') }}
                                            </div>
                                        </div>
                                        <div>
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body"
                        ...
                        <div class="flex-start">
                            <div>
                                <h4>{{ \App\CPU\translate('Status') }} : </h4>
                            </div>
                            <div class="mx-1">
                                <h4>{!! $seller->status == 'approved'
                                    ? '<label class="badge badge-success">Active</label>'
                                    : '<label class="badge badge-danger">In-Active</label>' !!}</h4>
                            </div>
                        </div>
                        <div class="flex-start">
                            <div>
                            ...
                            <div class="mx-1">
                                <h5>{{ $seller->f_name }} {{ $seller->l_name }}</h5>
                            </div>
                        </div>
                        <div class="flex-start">
                            <div>
                ...
                <div class="col-md-6 mt-2 mt-md-0">
                    <div class="card">
                        ...
                        <div class="card-body"
                            ...
                            <div class="flex-start">
                                <div>
                                    <h5>{{ \App\CPU\translate('shop_name') }} : </h5>
                                </div>
                                <div class="mx-1">
                    ...
                    <div class="card-body"
                        ...
                        <div class="mt-2">
                            <div class="flex-start">
                                ...
                                <div class="mx-1">
                                    <h4>{{ $seller->bank_name ? $seller->bank_name : \App\CPU\translate('No Data found') }}
                                    </h4>
                                </div>
                            </div>
                            <div class="flex-start">
                            ...
                            <div class="flex-start">
                                ...
                                <div class="mx-1">
                                    <h6>{{ $seller->holder_name ? $seller->holder_name : \App\CPU\translate('No Data found') }}
                                    </h6>
                                </div>
                            </div>
                            <div class="flex-start">
                                ...
                                <div class="mx-1">
                                    <h6>{{ $seller->account_no ? $seller->account_no : \App\CPU\translate('No Data found') }}
                                    </h6>
                                </div>
                            </div>
                            <div class="flex-start">
