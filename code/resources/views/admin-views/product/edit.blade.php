...
@section('content')
    ...
    @endif
                                ...
                                <div class="col-md-4 d-none" id="digital_product_type_show">
                                ...
                                <div class="col-md-4 d-none" id="digital_file_ready_show">
                                    <div class="row">
                                        <div class="col-md-6">
    ...
    @endforeach
                    ...
                    <div class="card mt-2 rest-part physical_product_show d-none">
                        <div class="card-header">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3 d-flex align-items-center gap-2">
                                        ...
                                        <label class="switcher title-color">
                                            <input type="checkbox" class="switcher_input" id="color_switcher"
                                                name="colors_active"
                                                {{ is_array($product['colors']) && count($product['colors']) > 0 ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group">
                                        <select
                                            ...
                                            {{ is_array($product['colors']) && count($product['colors']) > 0 ? '' : 'disabled' }}>
                                            @foreach (\App\Model\Color::orderBy('name', 'asc')->get() as $key => $color)
                                                <option value={{ $color->code }}
                                                    {{ in_array($color->code, is_array($product['colors']) ? $product['colors'] : []) ? 'selected' : '' }}>
                                                    {{ $color['name'] }}
                                                </option>
                                            @endforeach
                                        </select>
                        ...
                        <div class="card-body">
                            <div class="row align-items-end">
                                ...
                                <div class="col-md-3 form-group physical_product_show" id="quantity">
                                    ...
                                    <input type="number" min="1" value={{ $product->current_stock }}
                                ...
                                <div class="col-md-3 form-group physical_product_show" id="qty_step_size">
                                    <label class="title-color">{{ \App\CPU\translate('quantity_step_size') }}</label>
                                    <input type="number" min="1"
                                        value="{{ \App\CPU\Convert::default($product->qty_step_size) }}" step="1"
                                        placeholder="{{ \App\CPU\translate('quantity_step_size') }}"
                                        name="qty_step_size" class="form-control" required>
                                </div>
                                <div class="col-md-3 form-group physical_product_show" id="shipping_cost">
                                    <label
                    ...
                    <div class="card mt-2 mb-2 rest-part d-none">
                        <div class="card-header">
