...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="d-flex flex-wrap gap-2 align-items-center mb-3 customBtnDiv">
            ...
            <a href="{{ route('admin.product.list', ['in_house', '']) }}"><button
                    class="btn btn--primary px-4">Back</button></a> <!-- customBtnDiv-->
        </div>
        <!-- End Page Title -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select
                                            class="js-example-basic-multiple js-states js-example-responsive form-control"
                                            name="sub_category_id" id="sub-category-select" data-id=""
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 physical_product_show d-none">
    ...
    @endforeach
                            ...
                            <div class="card mt-2 rest-part">
                                ...
                                <div class="card-body">
                                    <div class="row align-items-end">
                                        ...
                                        <div class="col-md-3 form-group" id="qty_step_size">
                                            <label class="title-color">
                                                {{ \App\CPU\translate('quantity_step_size') }}</label>
                                            <input type="number" min="1" value="1" step="1"
                            ...
                            <div class="d-none card mt-2 mb-2 rest-part">
                                <div class="card-header">
