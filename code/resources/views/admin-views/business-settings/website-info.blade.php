        ...
        <form action="{{ route('admin.business-settings.update-info') }}" method="POST"
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 d-none">
                            <div class="form-group">
                                <label
                                    class="title-color d-flex">{{\App\CPU\translate('Sign_up_bonus')}}</label>
                                <input class="form-control" type="text" name="signup_bonus"
                                    value="{{ isset($signup_bonus->value)?$signup_bonus->value:'' }}"
                                    placeholder="{{\App\CPU\translate('signup_bonus')}}">
                            </div>
                        </div>
                        <div class="col-md-4 d-none">
                            <div class="form-group">
                                <label
                                    class="title-color d-flex">{{\App\CPU\translate('Minimum_Seller_Wallet')}}</label>
                                <input class="form-control" type="number" name="minimum_seller_wallet"
                                    value="{{ isset($minimum_seller_wallet->value)?$minimum_seller_wallet->value:'' }}"
                                    placeholder="{{\App\CPU\translate('minimum_seller_wallet')}}">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card mb-3 d-none">
                <div class="card-header">
                    <h5 class="mb-0 text-capitalize d-flex gap-1">
                        ...
                        {{\App\CPU\translate('WithDrawal_percentage')}}
                    </h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label
                                    class="title-color d-flex">{{\App\CPU\translate('TDS_in_(%)')}}</label>
                                <input class="form-control" type="text" name="tds_customer"
                                    value="{{ isset($tds_customer->value)?$tds_customer->value:'' }}"
                                    placeholder="{{\App\CPU\translate('tds_for_customer')}}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label
                                    class="title-color d-flex">{{\App\CPU\translate('Admin_Commission_(%)')}}</label>
                                <input class="form-control" type="text" name="admin_commission_customer"
                                    value="{{ isset($admin_commission_customer->value)?$admin_commission_customer->value:'' }}"
                                    placeholder="{{\App\CPU\translate('admin_commission_for_customer')}}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label
                                    class="title-color d-flex">{{\App\CPU\translate('re-Purchase_income_(%)')}}</label>
                                <input class="form-control" type="text" name="repurchase_income"
                                    value="{{ isset($repurchase_income->value)?$repurchase_income->value:'' }}"
                                    placeholder="{{\App\CPU\translate('repurchase_income')}}">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card mb-3 d-none">
                <div class="card-header">
                    <h5 class="mb-0 text-capitalize d-flex gap-1">
                        <i class="tio-briefcase"></i>
                        {{\App\CPU\translate('WithDrawal_percentage_for_frenchise')}}
                    </h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label
                                    class="title-color d-flex">{{\App\CPU\translate('TDS_in_(%)')}}</label>
                                <input class="form-control" type="text" name="tds_frenchise"
                                    value="{{ isset($tds_frenchise->value)?$tds_frenchise->value:'' }}"
                                    placeholder="{{\App\CPU\translate('tds_for_frenchise')}}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label
                                    class="title-color d-flex">{{\App\CPU\translate('Admin_Commission_(%)')}}</label>
                                <input class="form-control" type="text" name="admin_commission_frenchise"
                                    value="{{ isset($admin_commission_frenchise->value)?$admin_commission_frenchise->value:'' }}"
                                    placeholder="{{\App\CPU\translate('admin_commission_for_frenchise')}}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label
                                    class="title-color d-flex">{{\App\CPU\translate('team_level_income_(%)')}}</label>
                                <input class="form-control" type="text" name="team_level_income"
                                    value="{{ isset($team_level_income->value)?$team_level_income->value:'' }}"
                                    placeholder="{{\App\CPU\translate('team_level_income')}}">
                            </div>
                        </div>
                    </div>
                </div>
