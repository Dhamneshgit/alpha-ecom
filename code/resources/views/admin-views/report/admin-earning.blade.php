        ...
        <div class="card mb-2">
         ...
         <div class="store-report-content mb-2">
            <div class="left-content">
                ...
                <div class="left-content-card d-none">
            ...
            <div class="table-responsive">
                <table id="datatable"
                    ...
                    <tr>
                        ...
                        <th class="d-none">{{\App\CPU\translate('Commission Earning')}}</th>
                    ...
                    @foreach($inhouse_earn as $key=>$earning)
                        ...
                        <tr>
                            ...
                            <td class="d-none">{{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($admin_commission_earn[$key])) }}</td>
