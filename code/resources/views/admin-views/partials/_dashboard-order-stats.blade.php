@if (auth('admin')->user()->admin_role_id == 1)
    <div class="col-sm-6 col-lg-3">
        ...
        <div class="business-analytics">
            ...
            <img src="{{ asset('/public/assets/back-end/img/total-sale.png') }}" class="business-analytics__img"
                alt="">
        </div>
    ...
    <div class="col-sm-6 col-lg-3 d-none">
        <!-- Business Analytics Card -->
        <div class="business-analytics">
            <h5 class="business-analytics__subtitle">{{ \App\CPU\translate('Total Service Booking') }}</h5>
            <h2 class="business-analytics__title">{{ $data['total_sale'] }}</h2>
            <img src="{{ asset('/public/assets/back-end/img/total-sale.png') }}" class="business-analytics__img"
                alt="">
        </div>
    ...
    <div class="col-sm-6 col-lg-3">
        <!-- Business Analytics Card -->
        <div class="business-analytics">
            <h5 class="business-analytics__subtitle">{{ \App\CPU\translate('Total Goods Provider ') }}</h5>
            <h2 class="business-analytics__title">{{ $data['store'] }}</h2>
            <img src="{{ asset('/public/assets/back-end/img/total-stores.png') }}" class="business-analytics__img"
                alt="">
        </div>
        <!-- End Business Analytics Card -->
    </div>
    <div class="col-sm-6 col-lg-3 d-none">
        <!-- Business Analytics Card -->
        <div class="business-analytics">
            <h5 class="business-analytics__subtitle">{{ \App\CPU\translate('Total Service Provider') }}</h5>
            <h2 class="business-analytics__title">{{ $data['store_service'] }}</h2>
            <img src="{{ asset('/public/assets/back-end/img/total-stores.png') }}" class="business-analytics__img"
                alt="">
        </div>
        <!-- End Business Analytics Card -->
    ...
    <div class="col-sm-6 col-lg-3 d-none">
        <!-- Business Analytics Card -->
        <div class="business-analytics">
            <h5 class="business-analytics__subtitle">{{ \App\CPU\translate('Total Both Provider') }}</h5>
            <h2 class="business-analytics__title">{{ $data['both'] }}</h2>
            <img src="{{ asset('/public/assets/back-end/img/total-stores.png') }}" class="business-analytics__img"
                alt="">
        </div>
        <!-- End Business Analytics Card -->
    ...
    <div class="col-sm-6 col-lg-3">
        ...
        <div class="business-analytics">
            ...
            <img src="{{ asset('/public/assets/back-end/img/total-product.png') }}" class="business-analytics__img"
                alt="">
        </div>
        <!-- End Business Analytics Card -->
    </div>
    <div class="col-sm-6 col-lg-3 d-none">
        <!-- Business Analytics Card -->
        <div class="business-analytics">
            <h5 class="business-analytics__subtitle">{{ \App\CPU\translate('Total Service') }}</h5>
            <h2 class="business-analytics__title">{{ $data['services'] }}</h2>
            <img src="{{ asset('/public/assets/back-end/img/total-product.png') }}" class="business-analytics__img"
                alt="">
        </div>
        <!-- End Business Analytics Card -->
    ...
    <div class="col-sm-6 col-lg-3">
        ...
        <div class="business-analytics">
            ...
            <img src="{{ asset('/public/assets/back-end/img/total-customer.png') }}" class="business-analytics__img"
                alt="">
        </div>
        <!-- End Business Analytics Card -->
    </div>
    ...
    @elseif(auth('admin')->user()->admin_role_id == 2 || auth('admin')->user()->admin_role_id == 3)
