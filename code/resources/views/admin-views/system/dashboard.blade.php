...
@section('content')
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col-12 mb-2 mb-sm-0">
                        <h3 class="text-center">{{ \App\CPU\translate('hi') }} {{ ucfirst(auth('admin')->user()->name) }},
    ...
    @endif
    <div class="modal fade" id="bonus-modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="text-align: {{ Session::get('direction') === 'rtl' ? 'right' : 'left' }};">
                ...
                <form action="{{ route('admin.dashboard.withdrawal_request') }}" method="post">
                    <div class="modal-body">
                        ...
                        <div class="" id="method-filed__div1">
                        ...
                        <div class="mt-1">
                            ...
                            <input type="number" name="amount" step=".01"
                                value="{{ \App\CPU\BackEndHelper::usd_to_currency($data['user_bonus']) }}"
                    ...
                    <div class="modal-footer">
                        ...
                        @else
                            <button type="button" class="btn btn--primary" onclick="call_duty()">
                                {{ \App\CPU\translate('Incomplete kYC') }}
                            </button>
                        @endif
                    </div>
                </form>
...
@push('script_2')
    ...
    <script>
        $(document).ready(function() {
            ...
            let method_id = $('#withdraw_method1').val()
        ...
        function withdraw_method_field(method_id) {
            ...
            $.ajax({
                url: "{{ route('admin.dashboard.method-list') }}" + "?method_id=" + method_id,
                data: {},
                processData: false,
                contentType: false,
                type: 'get',
                success: function(response) {
                    ...
                    $("#method-filed__div1").html("");
                    method_fields.forEach((element, index) => {
                        $("#method-filed__div1").append(`
                        <div class="mt-3">
                            <label for="wr_num" class="fz-16 c1 mb-2" style="color: #5b6777 !important;">${element.input_name.replaceAll('_', ' ')}</label>
                            <input type="${element.input_type}" class="form-control" name="${element.input_name}" placeholder="${element.placeholder}" ${element.is_required === 1 ? 'required' : ''}>
                        </div>
