...
@section('title', \App\CPU\translate('Service Category'))
    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 d-flex gap-10">
                ...
                {{\App\CPU\translate('Service Category')}} {{\App\CPU\translate('Setup')}}
            </h2>
        </div>
        <!-- End Page Title -->
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <label class="title-color" for="status">{{\App\CPU\translate('Status')}}</label>

                                        <select class="form-control" name="status" id="" required>
                                            <option disabled selected>{{\App\CPU\translate('Select_Status')}}</option>
                                            <option value="0">{{\App\CPU\translate('In-Active')}}</option>
                                            <option value="1">{{\App\CPU\translate('Active')}}</option>
                                    ...
                                    <div class="d-none">
                                        <div class="form-group lang_form" id="form">
                                            ...
                                            <textarea class="d-none" name="description" class="form-control"></textarea>
                                        </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-4 col-md-6 col-lg-8 mb-2 mb-sm-0">
                                <h5 class="text-capitalize d-flex gap-1">
                                    {{ \App\CPU\translate('service_category_list')}}
                        ...
                        <table style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"
                            ...
                            <thead class="thead-light thead-50 text-capitalize">
                                <tr>
                                    ...
                                    <th class="text-center">{{ \App\CPU\translate('Admin_status')}}</th>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-10">
                                            <a class="btn btn-outline-info btn-sm square-btn"
                                                ...
                                                href="{{route('admin.servicecategory.edit',[$category['id']])}}">
                                                <i class="tio-edit"></i>
                                            </a>
...
@push('script')
<script src="https://cdn.ckeditor.com/4.21.2/standard/ckeditor.js"></script>
<script>
  ...
  $('[data-toggle="tooltip"]').tooltip()
    ...
    <script>
        $(document).on('change', '.category-status', function () {
            ...
            $.ajax({
                url: "{{route('admin.servicecategory.status')}}",
                method: 'POST',
                data: {
                    id: id,
                    home_status: status
        ...
        $(document).on('click', '.delete', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "{{route('admin.servicecategory.delete')}}",
                        method: 'POST',
                        data: {id: id},
                        success: function () {
