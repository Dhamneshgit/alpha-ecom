    ...
    <div class="content container-fluid">
        ...
        <div class="d-flex flex-wrap gap-2 align-items-center mb-3">
            <h2 class="h1 mb-0">
                ...
                @endif
                {{\App\CPU\translate('Service Category')}}
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                        <form action="{{route('admin.servicecategory.update',[$category['id']])}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="{{ $category['parent_id']==0 || $category['position'] == 1 ? 'col-lg-6':'col-12' }}">
                                    ...
                                    <div class="form-group">
                                        <label class="title-color" for="priority">{{\App\CPU\translate('status')}}</label>
                                        <select class="form-control" name="status" id="" required>
                                            <option disabled selected>{{\App\CPU\translate('Select_Status')}}</option>
                                            <option value="0" {{$category['home_status']==0?'selected':''}}>{{\App\CPU\translate('In-Active')}}</option>
                                            <option value="1" {{$category['home_status']==1?'selected':''}}>{{\App\CPU\translate('Active')}}</option>
