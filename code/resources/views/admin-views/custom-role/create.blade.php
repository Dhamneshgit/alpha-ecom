            ...
            <div class="card-body">
                <form id="submit-create-role" method="post" action="{{ route('admin.custom-role.store') }}"
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <select name="name" class="form-control" id="name" required>
                                    ...
                                    <option value="Customer Controller">Customer Controller</option>
                                    <option value="Vendor Controller">Vendor Controller</option>
                                    <option value="Home Checkup">Doctor</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex gap-4 flex-wrap">
                        <label for="name"
                            class="title-color font-weight-bold mb-0">{{ \App\CPU\translate('module_permission') }} </label>
                    ...
                    <div class="row">
                        ...
                        <!-- <div class="col-sm-6 col-lg-3">
                            <div class="form-group d-flex gap-2">
                                <input type="checkbox" name="modules[]" value="pos_management" id="pos_management">
                                <label class="title-color mb-0"
                                    style="{{ Session::get('direction') === 'rtl' ? 'margin-right: 1.25rem;' : '' }};"
                        ...
                        <!-- <div class="col-sm-6 col-lg-3">
                            <div class="form-group d-flex gap-2">
                                <input type="checkbox" class="module-permission" name="modules[]" value="appointment"
                                    id="appointment">
                                <label class="title-color mb-0"
                                    style="{{ Session::get('direction') === 'rtl' ? 'margin-right: 1.25rem;' : '' }};"
                        ...
                        <form action="{{ url()->current() }}?search={{ $search }}" method="GET">
                            <div class="input-group input-group-merge input-group-custom">
                                ...
                                <input id="datatableSearch_" type="search" name="search" class="form-control"
                                    placeholder="{{ \App\CPU\translate('search_role') }}" value="{{ $search }}">
                                <button type="submit"
