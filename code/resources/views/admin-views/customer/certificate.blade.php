...
.business2 .back .top {
  ...
  box-sizing: border-box;
  height: 70%;
  background: url("{{asset('public/images/e.webp')}}")
    center;
  filter: contrast(160%);
  position: relative;
}
...
<div class="business2">
        ...
        <div class="front">
            <div class="red">
                ...
                <div class="head">
                    <img src="{{asset('public/images/logo.png')}}" class="card-logo" alt="logo">
                    
                </div>
            </div>
            <div class="avatar">
                <div class="img">
                    <img src="{{asset('storage/app/public/profile/'.$customer->image)}}" alt="">
                </div>
                <p>{{ucfirst($customer->f_name)}} {{ucfirst($customer->l_name)}}</p>
                <!-- <p>Graphic Designer</p> -->
            </div>
            <div class="infos">
                <div>
                    <div style="width: 140px; ">
                        <p style=" display: flex; justify-content: space-between; align-items: center;"><span>Grocypay ID</span> <span>:-</span></p>
                    </div>
                    <div>
                        <p>{{ucfirst($customer->id)}}</p>
                     
                    </div>
                </div>
                <div>
                    <div style="width: 140px; ">
                        <p style=" display: flex; justify-content: space-between; align-items: center;"><span>Joining Date</span> <span>:-</span></p>
                    </div>
                    <div>
                       
                        <p>{{\Carbon\carbon::parse($customer->created_at)->format('Y-m-d')}}</p>
                    </div>
                </div>
                <div>
                    <div style="width: 140px; ">
                        <p style=" display: flex; justify-content: space-between; align-items: center;"><span>Mobile No.</span> <span>:-</span></p>
                    </div>
                    <div>
                        <p>{{ucfirst($customer->phone)}}</p>
                        
                    </div>
                </div>
                <div>
                    <div style="width: 140px; ">
                        <p style=" display: flex; justify-content: space-between; align-items: center;"><span>Packege</span> <span>:-</span></p>
                    </div>
                    <div>
                        <p>{{ucfirst($plan->title ?? '')}}</p>
                     
                    </div>
                </div>
                <!-- <div class="d-none">
                    <div style="width: 140px; ">
                        <p style=" display: flex; justify-content: space-between; align-items: center;"><span>Subscription Date</span> <span>:-</span></p>
                    </div>
                    <div>
                        <p>19-06-2024</p>
                ...
                <div>
                    <div style="width: 140px; ">
                        <p style=" display: flex; justify-content: space-between; align-items: center;"><span>Subscription Expire Date</span> <span>:-</span></p>
                    </div>
                    <div>
                        <p>{{$customer->plan_expire_date}}</p>
        ...
        <div class="back">
            <div class="top">
                <div>
                    ...
                    <img src="{{asset('public/images/logo.png')}}" class="card-logo" alt="">
                
                    <!--<p>{{ucfirst($customer->city) }}</p>-->
                    <p><b>Address:- </b><br> S.N 99/158/2, Vijay Nagar, Shanti Colony- A, Pune City, Kalewadi, Pune-411017
                    </p>
                </div>
            </div>
            <div class="webicon">
            ...
            <!--<p>{{asset('/')}}</p>-->
            <P>GROCYPAY TECHPLATFORM PVT.LTD.<br><a href="https://www.grocypay.com/">https://www.grocypay.com/</a></p>
        </div>
