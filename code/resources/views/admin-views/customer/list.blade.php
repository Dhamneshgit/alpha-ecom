...
@section('title', \App\CPU\translate('User List'))
                ...
                <div class="row gy-2 align-items-center">
                    ...
                    <div class="col-sm-4 col-md-6 col-lg-8 mb-2 mb-sm-0">
                        <div class="d-flex justify-content-sm-end">
                            ...
                            <a href="{{ route('admin.customer.add_new') }}">
                                <button type="button" class="btn btn-primary">
                                    <i class="tio-plus-user"></i>
                ...
                <table style="text-align: {{ Session::get('direction') === 'rtl' ? 'right' : 'left' }};"
                    ...
                    <thead class="thead-light thead-50 text-capitalize">
                        <tr>
                            ...
                            <th class="d-none">{{ \App\CPU\translate('Zipcode') }}</th>
                    ...
                    <tbody>
                        @foreach ($customers as $key => $customer)
                            <tr>
                                ...
                                <td class="d-none">
                                    <div class="mb-1">
                                        <strong><a class="title-color">{{ $customer->zipcode }}</a></strong>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center gap-2">
                                        ...
                                        <a title="{{ \App\CPU\translate('Download') }}"
                                            class="d-none btn btn-outline-info btn-sm square-btn"
                                            href="{{ route('admin.customer.certificate', [$customer['id']]) }}">
                                            <i class="tio-file"></i>
                                        </a>
                                        <a title="{{ \App\CPU\translate('delete') }}"
                                            class="btn btn-outline-danger btn-sm delete square-btn d-none"
                                            href="javascript:"
