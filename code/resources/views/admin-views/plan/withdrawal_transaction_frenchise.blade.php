...
@section('title', \App\CPU\translate('Withdrawal list'))
                    ...
                    <div class="table-responsive">
                        <table id="datatable"
                            ...
                            <tr>
                                ...
                                <th>{{\App\CPU\translate('Team Level Amount')}}</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if($c->status)
                                            Money Transfered
                                        @else
                                        <a href="{{route('admin.plan.frenchisestatus',[$c->id])}}">
