...
@section('title', \App\CPU\translate('Seller Fund'))
    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                ...
                {{\App\CPU\translate('Seller_Fund_List')}}
            </h2>
        </div>
        <!-- End Page Title -->
                        ...
                        <div class="row justify-content-between align-items-center flex-grow-1">
                            <div class="col-sm-4 col-md-6 col-lg-8 mb-2 mb-sm-0">
                                <h5 class="mb-0 text-capitalize d-flex gap-2">
                                    {{\App\CPU\translate('user_Fund_List')}}
                    ...
                    <div class="table-responsive">
                        <table id="datatable"
                            ...
                            <tr>
                                ...
                                <th>{{\App\CPU\translate('User Name')}}</th>
                            ...
                            @foreach($data as $k=>$c)
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <a href="{{route('admin.customer.view',[$c->user_id])}}"
                                                class="title-color hover-c1 d-flex align-items-center gap-10" target="_blank">
                                            {{substr($c->f_name,0,20)}}  {{substr($c->l_name,0,20)}}
                                            </a>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <div class="modal fade" id="exampleModal{{$c->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <form action="{{route('admin.sellers.update_fund_request')}}" method="POST">
                                                @csrf
                                                <div class="modal-dialog" role="document">
                                                    ...
                                                    <div class="modal-body">
                                                       <div class="row">
                                                              ...
                                                              <div class="col-8">
                                                                   <input name="amount" class="form-control" value="{{$c->amount}}">         
                                                              </div>          
                                                              <div class="col-4">
                                                                   <lable>
                                                                        Transaction Id: 
                                                              ...
                                                              <div class="col-8">
                                                                   <input name="transaction_id" class="form-control" value="{{$c->transaction_id}}">         
                                                              </div>          
                                                              <div class="col-4">
                                                                   <lable>
                                                                        Status: 
                                                              ...
                                                              <div class="col-8">
                                                                   <select name="status" class="form-control">
                                                                        ...
                                                                        <option value="1" {{($c->status == 1 ) ? 'selected' : ''}}>Approve</option>
                                                                        <option value="2" {{($c->status == 2 ) ? 'selected' : ''}}>Reject</option>
                                                                   </select>        
                                                              </div>          
                                                              <div class="col-4">
                                                                   <lable>
                                                              ...
                                                              <div class="col-8">
                                                                   <a href="{{asset('storage/app/public/users/'.$c->image)}}" target="_blank"><img src="{{asset('storage/app/public/users/'.$c->image)}}" style="height:150px; width:150px;"/> </a>       
                                                              </div>          
                                                       </div>
                                                    </div>
