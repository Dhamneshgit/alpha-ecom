                        ...
                        <form action="{{route('admin.plan.store-plan')}}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-3 form-group">
                                    ...
                                    <input type="number" min="1" max="1000" name="days" value="{{ old('days') }}" class="form-control"
                                        id="minimum purchase"
                                ...
                                <div class="col-md-6 col-lg-3 form-group">
                                    ...
                                    <select class="form-control w-100" name="seller_type">
                                        <option value="goods">{{\App\CPU\translate('Goods')}}</option>
                                        <option value="service">{{\App\CPU\translate('Service')}}</option>
                                        <option value="both">{{\App\CPU\translate('Both')}}</option>
                                    </select>
                                </div>

                                <!-- <input type="number" name="days" value="365" class="form-control"> -->
                                ...
                                <!-- <div class="col-md-6 col-lg-3 form-group" id="max-discount d-none">
                                ...
                                <!-- <div class="col-12" id="heading_div d-none">
                                ...
                                <!-- <div class="d-none col-md-12 col-lg-12 form-group" id="input_fields">
                                </div>

                                <div class="col-md-4 col-lg-3 form-group d-none">
                                    <label for="name" class="title-color font-weight-medium d-flex">{{\App\CPU\translate('Frenchise_bonus')}}</label>
                                    <input id="daily_bonus" type="text" name="frenchise_bonus" value="{{ old('frenchise_bonus') }}" class="form-control"
                                        placeholder="{{\App\CPU\translate('frenchise_bonus')}}" >
                                </div>
                                <div class="col-md-4 col-lg-3 form-group">
                                    <label for="name" class="title-color font-weight-medium d-flex">{{\App\CPU\translate('district_bonus')}}</label>
                                    <input id="daily_bonus" type="text" name="district_bonus" value="{{ old('district_bonus') }}" class="form-control"
                                        placeholder="{{\App\CPU\translate('district_bonus')}}" >
                                </div>
                                <div class="col-md-4 col-lg-3 form-group">
                                    <label for="name" class="title-color font-weight-medium d-flex">{{\App\CPU\translate('state_bonus')}}</label>
                                    <input id="daily_bonus" type="text" name="state_bonus" value="{{ old('state_bonus') }}" class="form-control"
                                        placeholder="{{\App\CPU\translate('state_bonus')}}" >
                                </div>
                                <div class="col-md-4 col-lg-3 form-group">
                                    <label for="name" class="title-color font-weight-medium d-flex">{{\App\CPU\translate('shop_bonus')}}</label>
                                    <input id="daily_bonus" type="text" name="shop_bonus" value="{{ old('shop_bonus') }}" class="form-control"
                                        placeholder="{{\App\CPU\translate('shop_bonus')}}" >
                                </div>
                                <div class="col-md-4 col-lg-4 form-group">
                                    <label for="name" class="title-color font-weight-medium d-flex">{{\App\CPU\translate('Re-purchase_Frenchise_bonus_(%)')}}</label>
                                    <input id="daily_bonus" type="text" name="repurchase_frenchise_bonus" value="{{ old('repurchase_frenchise_bonus') }}" class="form-control"
                                        placeholder="{{\App\CPU\translate('repurchase_frenchise_bonus')}}" >
                                </div>
                                <div class="col-md-4 col-lg-4 form-group">
                                    <label for="name" class="title-color font-weight-medium d-flex">{{\App\CPU\translate('Re-purchase_district_bonus_(%)')}}</label>
                                    <input id="daily_bonus" type="text" name="repurchase_district_bonus" value="{{ old('repurchase_district_bonus') }}" class="form-control"
                                        placeholder="{{\App\CPU\translate('repurchase_district_bonus')}}" >
                                </div>
                                <div class="col-md-4 col-lg-4 form-group">
                                    <label for="name" class="title-color font-weight-medium d-flex">{{\App\CPU\translate('Re-purchase_state_bonus_(%)')}}</label>
                                    <input id="daily_bonus" type="text" name="repurchase_state_bonus" value="{{ old('repurchase_state_bonus') }}" class="form-control"
                                        placeholder="{{\App\CPU\translate('repurchase_state_bonus')}}" >
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4 form-group">
                                    ...
                                    <input id="daily_bonus" type="number" name="daily_bonus_till_days" value="{{ old('daily_bonus_till_days') }}" class="form-control"
                                        placeholder="{{\App\CPU\translate('Daily Bonus till Days')}}" >
                                </div>
                                <div class="col-md-6 col-lg-4 form-group">
                                    ...
                                    <input id="daily_bonus_limit" type="number" name="daily_bonus_limit" value="{{ old('daily_bonus_limit') }}" class="form-control"
                                        placeholder="{{\App\CPU\translate('daily_bonus_limit')}}" >
                                </div>

                                <div class="col-md-6 col-lg-4 form-group">
                                    <label for="name" class="title-color font-weight-medium d-flex">{{\App\CPU\translate('customer_self_purchase_bonus_in_(%)')}}</label>
                                    <input id="daily_bonus_limit" type="number" name="self_purchase_bonus" value="{{ old('self_purchase_bonus') }}" class="form-control"
                                        placeholder="{{\App\CPU\translate('self_purchase_bonus')}}" >
                                </div> -->
                            </div>
                    ...
                    <div class="table-responsive">
                        <table id="datatable"
                            ...
                            <tr>
                                ...
                                <!-- <th>{{\App\CPU\translate('no_level')}}</th> -->
        ...
        $("#num_fields").keyup(function(e){
            ...
            if(!isNaN(numFields) && numFields > 0) {
                ...
                for(var i = 1; i <= numFields; i++) {
                    $("#input_fields").append(`<div class="row  justify-content-center  align-items-center my-1 ">
                    <div class="col-lg-2 col-md-4 col-6">
