...
@section('title', \App\CPU\translate('User Referral'))
    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                ...
                {{\App\CPU\translate('user_Referral_Transactions')}}
            </h2>
        </div>
        <!-- End Page Title -->
                        ...
                        <table id="datatable"
                            ...
                            @foreach($cou as $k=>$c)
                                <tr>
                                    ...
                                    <td>
                                        <div>{{($c['referral_f_name']) ? substr($c['referral_f_name'],0,20) : '-'}}  {{substr($c['referral_l_name'],0,20)}}</div>
                                        <!-- <strong>{{\App\CPU\translate('code')}}: {{$c['code']}}</strong> -->
                                    </td>
                                    <td>
