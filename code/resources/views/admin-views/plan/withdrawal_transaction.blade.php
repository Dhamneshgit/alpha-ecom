    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                ...
                {{\App\CPU\translate('User_Withdrawal_List')}}
            </h2>
        </div>
        <!-- End Page Title -->
                        ...
                        <div class="row justify-content-between align-items-center flex-grow-1">
                            <div class="col-sm-4 col-md-6 col-lg-8 mb-2 mb-sm-0">
                                <h5 class="mb-0 text-capitalize d-flex gap-2">
                                    {{\App\CPU\translate('user_Plan_Transactions_List')}}
                    ...
                    <div class="table-responsive">
                        <table id="datatable"
                            ...
                            <tr>
                                ...
                                <th>{{\App\CPU\translate('Wallet Type')}}</th>
                                <th>{{\App\CPU\translate('Tds')}}</th>
                                <th>{{\App\CPU\translate('Admin Commission')}}</th>
                                <th>{{\App\CPU\translate('Re-Purchase Amount')}}</th>
                                <th>{{\App\CPU\translate('Remaining Amount')}}</th>
                                <th>{{\App\CPU\translate('WithDrawal Date')}}</th>
                            ...
                            @foreach($data as $k=>$c)
                                <tr>
                                    ...
                                    <td>
                                        <div>{{($c->admin_commission)}}</div>
                                        
                                    </td>
                                    <td>
                                        <div>{{($c->repurchase_income)}}</div>
                                        
                                    </td>
                                    <td>
                                        <div>{{($c->remaning_amount)}}</div>
                                    ...
                                    <td>
                                        ...
                                        @if($c->status)
                                            Money Transfered
                                        @else
                                        <a href="{{route('admin.plan.userstatus',[$c->id])}}">
