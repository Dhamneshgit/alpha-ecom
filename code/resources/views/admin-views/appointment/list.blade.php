...
@section('title', \App\CPU\translate('Appointment List'))
@push('css_or_js')
    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                ...
                {{ \App\CPU\translate('Appointment_list') }}
            </h2>
        </div>
        <!-- End Page Title -->
                ...
                <div class="card">
                    <div class="card-header flex-wrap gap-10">
                        <h5 class="mb-0 d-flex gap-2 align-items-center">
                            {{ \App\CPU\translate('Appointment_table') }}
                        ...
                        <table id="datatable"
                            ...
                            <thead class="thead-light thead-50 text-capitalize table-nowrap">
                                <tr>
                                    ...
                                    {{-- <th>{{ \App\CPU\translate('Reffer By') }}</th> --}}
                                ...
                                @foreach ($em as $k => $e)
                                    @if ($e->role)
                                        <tr>
                                            ...
                                            {{-- <td class="text-capitalize">{{ $e['zipcode'] }}</td> --}}
                                            {{-- <td>{{ $e['username'] ?? '' }} {{ $e['userlastname'] ?? '' }}</td> --}}
                                            {{-- <td>{{ $e['f_name'] ?? '' }} {{ $e['l_name'] ?? '' }}</td> --}}
                                            <td>
                                                {{ $e['email'] }}
                                            </td>
                                            <td>{{ $e['phone'] }}</td>
