    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex gap-2">
                ...
                @if ($type == 'in_house')
                    {{ \App\CPU\translate('Service_Product_List') }}
                @elseif($type == 'seller')
                    {{ \App\CPU\translate('Seller_Service_Product_List') }}
                @endif
                            ...
                            <div class="col-lg-8 mt-3 mt-lg-0 d-flex flex-wrap gap-3 justify-content-lg-end">
                                @if ($type == 'in_house')
                                    ...
                                    <a href="{{ route('admin.product.stock-limit-list', ['in_house']) }}"
                                        ...
                                        <span class="text">{{ \App\CPU\translate('Limited Stocks') }}</span>
                                    </a>
                                @endif
                        ...
                        <table id="datatable"
                            ...
                            <thead class="thead-light thead-50 text-capitalize">
                                <tr>
                                    ...
                                    <th class="text-right">{{ \App\CPU\translate('Service Category') }}</th>
                                    <th class="text-right">{{ \App\CPU\translate('price') }}</th>
                                    <th class="text-right">{{ \App\CPU\translate('seller') }}</th>
                                    <!-- <th class="text-center">{{ \App\CPU\translate('Show_as_featured') }}</th> -->
                                    <th class="text-center">{{ \App\CPU\translate('Total_Booking') }}</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($pro as $k => $p)
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <b>{{ $p->seller ? $p->seller['f_name'] . ' ' . $p->seller['l_name'] : 'N/A' }}</b>
                                            <br>
                                            <b>{{ $p->seller ? $p->seller['phone'] : 'N/A' }}</b>
                                        </td>
                                        <td class="text-right">
                                            {{ $p['booking_count'] ?? 0 }}
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center gap-2">
                                                <a class="d-none btn btn-outline-info btn-sm square-btn" title="{{ \App\CPU\translate('barcode') }}"
                                                    href="{{ route('admin.product.barcode', [$p['id']]) }}">
                                                    <i class="tio-barcode"></i>
                                                </a>
                                                <a class="btn btn-outline-info btn-sm square-btn" title="View"
                                                    href="{{ route('admin.service.view', [$p['id']]) }}">
                                                    <i class="tio-invisible"></i>
                                                </a>
                                                <a class="d-none btn btn-outline--primary btn-sm square-btn" title="{{ \App\CPU\translate('Edit') }}"
                                                    href="{{ route('admin.service.edit', [$p['id']]) }}">
                                                    <i class="tio-edit"></i>
                                                </a>
                                                <a class="d-none btn btn-outline-danger btn-sm square-btn" href="javascript:"
