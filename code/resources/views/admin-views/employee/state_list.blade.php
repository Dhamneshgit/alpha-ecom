...
@section('title', \App\CPU\translate('Home Checkup List'))
@push('css_or_js')
    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                ...
                {{ \App\CPU\translate('Home_Checkup_list') }}
            </h2>
        </div>
        <!-- End Page Title -->
                ...
                <div class="card">
                    <div class="card-header flex-wrap gap-10">
                        <h5 class="mb-0 d-flex gap-2 align-items-center">
                            {{ \App\CPU\translate('Manufacturer_table') }}
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('admin.employee.add-new-state') }}" class="btn btn--primary">
                                <i class="tio-add"></i>
