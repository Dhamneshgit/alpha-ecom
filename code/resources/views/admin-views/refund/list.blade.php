    ...
    <div class="card">
        ...
        <div class="p-3">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-12 mt-3 col-md-8 d-none">
                        ...
                        <td>
                            <div class="d-inline-flex flex-column gap-1">
                                @if($refund->status=='pending')
                                    <span class="badge badge-soft--primary">{{\App\CPU\translate($refund->status)}}</span>
                                @elseif($refund->status=='approved')
                                    <span class="badge badge-soft-success">{{\App\CPU\translate($refund->status)}}</span>
                                @elseif($refund->status=='rejected')
                                    <span class="badge badge-soft-danger">{{\App\CPU\translate($refund->status)}}</span>
                                @else
                                    <span class="badge badge-soft-warning">{{\App\CPU\translate($refund->status)}}</span>
                                @endif
                            </div>
                        </td>
                        <td>
