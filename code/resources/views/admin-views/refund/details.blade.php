                    ...
                    <div class="card-body">
                        <div class="row gy-2">
                            ...
                            <div class="col-sm-8 col-md-4 col-lg-6">
                                ...
                                <div class="mb-1">{{ \App\CPU\translate('QTY') }} :
                                    {{ isset($refund->order_details->qty) ? $refund->order_details->qty : '' }}
                                </div>
                                <div class="mb-1">{{ \App\CPU\translate('price') }} :
                                    @if ($refund->order_details)
                                        {{ \App\CPU\Helpers::currency_converter($refund->order_details->price) }}
                                    @endif
                                </div>

                                @if ($refund->order_details && $refund->order_details->variant)
                    ...
                    <div class="card-body">
                        <div class="row gy-2">
                            <div class="col-sm-6 col-md-4 d-flex flex-column gap-10">
                                ...
                                @if ($order && $order->seller_is == 'seller' && $order->seller != null)
                                ...
                                @elseif($order && $order->seller_is == 'admin')
                            ...
                            <div class="col-sm-6 col-md-4 d-flex flex-column gap-10">
                                ...
                                <div class="d-flex flex-wrap gap-2">{{ \App\CPU\translate('order_details') }} :
                                    @if ($order)
                                ...
                                <div class="gallery grid-gallery">
                                    @foreach (json_decode($refund->images) as $key => $photo)
                                        <a href="{{ asset('storage/app/public/refund') }}/{{ $photo }}"
                                            ...
                                            <img src="{{ asset('storage/app/public/refund') }}/{{ $photo }}"
                                                alt="">
                                        </a>
                                    @endforeach
                                </div>
