            ...
            <div class="navbar-vertical-footer-offset pb-0">
                <div class="navbar-brand-wrapper justify-content-between side-logo">
                    ...
                    <a class="navbar-brand" href="{{ route('admin.dashboard.index') }}" aria-label="Front">
                        <img onerror="this.src='{{ asset('public/assets/back-end/img/900x400/img1.jpg') }}'"
                            class="navbar-brand-logo-mini for-web-logo max-h-custom"
                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if (\App\CPU\Helpers::module_permission_check('order_management'))
                            ...
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <!-- <li
                                        class="d-none nav-item {{ Request::is('admin/orders/list/failed') ? 'active' : '' }}  ">
                            ...
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/refund-section/refund/seller-list') ? 'active' : '' }}">
                                        <a class="nav-link" href="{{ route('admin.refund-section.refund.seller') }}"
                                            title="{{ \App\CPU\translate('seller_list') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">
                                                {{ \App\CPU\translate('Seller Refund List') }}
                                            </span>
                                        </a>
                                    </li>
                        ...
                        {{-- @if (\App\CPU\Helpers::module_permission_check('appointment'))
                            <li class="nav-item {{ Request::is('admin/bookings*') ? 'scroll-here' : '' }}">
                                <small class="nav-subtitle"
                                    title="">{{ \App\CPU\translate('Service_Booking_management') }}</small>
                                <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                            </li>
                            @if (auth('admin')->user()->admin_role_id == 1 || auth('admin')->user()->admin_role_id == 5)
                            <li class="nav-item {{ Request::is('admin/servicecategory/view') ? 'active' : '' }}">
                                <a class="nav-link " href="{{ route('admin.servicecategory.view') }}"
                                    title="{{ \App\CPU\translate('Service Categories') }}">
                                    <i class="tio-filter-list nav-icon"></i>
                                    <span class="text-truncate">{{ \App\CPU\translate('Service Categories') }}</span>
                                </a>
                            </li>
                            <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/service/list/in_house') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('admin.service.list', ['in_house', '']) }}"
                                    title="{{ \App\CPU\translate('Service List') }}">
                                    <i class="tio-filter-list nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ \App\CPU\translate('Service List') }}</span>
                                </a>
                            </li>
                            <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/bookings/list/doctor-appointment') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('admin.bookings.doctorAppointment') }}"
                                    title="{{ \App\CPU\translate('Service Booking') }}">
                                    <i class="tio-filter-list nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ \App\CPU\translate('Service Booking') }}</span>
                                </a>
                            </li>
                            @endif
                        ...
                        @if (\App\CPU\Helpers::module_permission_check('product_management'))
                            ...
                            <!-- <li
                                class=" d-none navbar-vertical-aside-has-menu {{ Request::is('admin/attribute*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        @if (\App\CPU\Helpers::module_permission_check('promotion_management'))
                            ...
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <!-- <li
                                        class="d-none navbar-vertical-aside-has-menu {{ Request::is('admin/deal/day') || Request::is('admin/deal/day-update*') ? 'active' : '' }}  ">
                                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        @if (\App\CPU\Helpers::module_permission_check('support_section'))
                            ...
                            <!-- <li
                                class="d-none  navbar-vertical-aside-has-menu {{ Request::is('admin/contact*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
...
@endif
                        ...
                        {{-- <li
                            ...
                            <small class="nav-subtitle"
                                title="">{{ \App\CPU\translate('city_&_pincode') }}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>
                        ...
                        @if (auth('admin')->user()->admin_role_id == 1)
                            <li
                                ...
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    ...
                                    title="{{ \App\CPU\translate('Zipcode') }}">
                                    <i class="tio-chart-bar-4 nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        <span class="position-relative">
                                            {{ \App\CPU\translate('zipcode') }}
                                        </span>
                                    </span>
                                </a>
                            </li>
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/area/city') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('admin.area.city') }}"
                                    title="{{ \App\CPU\translate('City/State') }}">
                                    <i class="tio-chart-bar-4 nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        <span class="position-relative">
                                            {{ \App\CPU\translate('City/State') }}
                                        </span>
                                    </span>
                                </a>
                            </li>
                        @endif --}}
                        <!-- <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/area/view') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                               href="{{ route('admin.area.view') }}" title="{{ \App\CPU\translate('State') }}">
                                <i class="tio-chart-bar-4 nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                    <span class="position-relative">
                                        {{ \App\CPU\translate('State') }}
                                    </span>
                                </span>
                            </a>
                        </li> -->
                        ...
                        {{-- @if (auth('admin')->user()->admin_role_id == 1)
                            <li
                                class="nav-item {{ Request::is('admin/support-ticket*') || Request::is('admin/contact*') ? 'scroll-here' : '' }}">
                                <small class="  nav-subtitle"
                                    title="">{{ \App\CPU\translate('subscription') }}</small>
                                <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                            </li>

                            <li
                                class="  navbar-vertical-aside-has-menu {{ Request::is('admin/plan/add-new') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('admin.plan.add-new') }}"
                                    title="{{ \App\CPU\translate('PLans') }}">
                                    <i class="tio-chart-bar-4 nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        <span class="position-relative">
                                            {{ \App\CPU\translate('Subscription') }}
                                        </span>
                                    </span>
                                </a>
                            </li>
                            <li
                                class="  navbar-vertical-aside-has-menu {{ Request::is('admin/plan/plantransactions') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('admin.plan.plantransactions') }}"
                                    title="{{ \App\CPU\translate('PLans') }}">
                                    <i class="tio-chart-bar-4 nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        <span class="position-relative">
                                            {{ \App\CPU\translate('Seller_Plans_Transaction') }}
                                        </span>
                                    </span>
                                </a>
                            </li>
                        @endif --}}
                        <!-- <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/area*') || Request::is('admin/sub*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                href="javascript:" title="{{ \App\CPU\translate('Area_setup') }}">
                                <i class="tio-filter-list nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                    {{ \App\CPU\translate('City_&_Area') }}
                                </span>
                            </a>
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{ Request::is('admin/area*') || Request::is('admin/sub*') ? 'block' : '' }}">
                                <li class="nav-item {{ Request::is('admin/area/view') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('admin.area.view') }}"
                                        title="{{ \App\CPU\translate('State') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{ \App\CPU\translate('State') }}</span>
                                    </a>
                                </li>
                                <li class="nav-item {{ Request::is('admin/sub-category/view') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('admin.sub-category.view') }}"
                                        title="{{ \App\CPU\translate('Sub_Categories') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{ \App\CPU\translate('City') }}</span>
                                    </a>
                                </li>
                                <li class="nav-item {{ Request::is('admin/sub-sub-category/view') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('admin.sub-sub-category.view') }}"
                                        ...
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span
                                            class="text-truncate">{{ \App\CPU\translate('Pincode') }}</span>
                                    </a>
                                </li>
                            </ul>
                        </li> -->
                        ...
                        @if (\App\CPU\Helpers::module_permission_check('user_section'))
                            ...
                            <li
                                ...
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    ...
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ \App\CPU\translate('Users') }}</span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        ...
                                        <a class="nav-link " href="{{ route('admin.customer.list') }}"
                                            ...
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{ \App\CPU\translate('Users_List') }}
                                            </span>
                                        </a>
                                    </li>
                                    @if (auth('admin')->user()->admin_role_id == 1)
                                        <li class="nav-item {{ Request::is('admin/reviews*') ? 'active' : '' }}  ">
                                            <a class="nav-link" href="{{ route('admin.reviews.list') }}"
                                                ...
                                                <span
                                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                                    {{ \App\CPU\translate('Users') }}
                                                    {{ \App\CPU\translate('Reviews') }}
                                                </span>
                                            </a>
                                        </li>
                                        <!-- <li
                                            class="d-none nav-item {{ Request::is('admin/customer/wallet/report') ? 'active' : '' }}  ">
                                        ...
                                        <li
                                            class=" d-none nav-item {{ Request::is('admin/customer/withdrawal_list') ? 'active' : '' }}">
                                            <a class="nav-link" title="{{ \App\CPU\translate('Withdrawal_List') }}"
                                                href="{{ route('admin.customer.withdrawal_list') }}">
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span class="text-truncate">
                                                    {{ \App\CPU\translate('Withdrawal_List') }}
                                                </span>
                                            </a>
                                        </li> -->
                                        <!-- <li
                                            class=" d-none  nav-item {{ Request::is('admin/customer/fund_list') ? 'active' : '' }}">
                                            <a class="nav-link"
                                                title="{{ \App\CPU\translate('fund_Request_List') }}"
                                                href="{{ route('admin.customer.fund_list') }}">
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span class="text-truncate">
                                                    {{ \App\CPU\translate('fund_Request_List') }}
                                                </span>
                                            </a>
                                        </li> -->
                                    @endif
                            ...
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    {{-- <li
                                        class="nav-item {{ Request::is('admin/sellers/service-seller-list') ? 'active' : '' }}">
                                        <a class="nav-link" title="{{ \App\CPU\translate('Seller_List') }}"
                                            href="{{ route('admin.sellers.service-seller-list') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">
                                                {{ \App\CPU\translate('Service_Seller_List') }}
                                            </span>
                                        </a>
                                    </li>
                                    <li
                                        class="nav-item {{ Request::is('admin/sellers/both-seller-list') ? 'active' : '' }}">
                                        <a class="nav-link" title="{{ \App\CPU\translate('Seller_List') }}"
                                            href="{{ route('admin.sellers.both-seller-list') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">
                                                {{ \App\CPU\translate('both_provider_List') }}
                                            </span>
                                        </a>
                                    </li> --}}
                                    @if (auth('admin')->user()->admin_role_id == 1)
                                        <li
                                            ...
                                            <a class="nav-link " href="{{ route('admin.sellers.withdraw_list') }}"
                                                ...
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span
                                                    class="text-truncate">{{ \App\CPU\translate('withdraws') }}</span>
                                            </a>
                                        </li>
                                        {{-- <li
                                        ...
                                        <!-- <li
                                            class=" d-none nav-item {{ Request::is('admin/sellers/fund_request') ? 'active' : '' }}">
                                            <a class="nav-link " href="{{ route('admin.sellers.fund_request') }}"
                                                title="{{ \App\CPU\translate('Request Money') }}">
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span
                                                    class="text-truncate">{{ \App\CPU\translate('Request Money') }}</span>
                                            </a>
                                        </li> -->
                                    @endif
                                </ul>
                            ...
                            {{-- <li
                                class="navbar-vertical-aside-has-menu  d-none {{ Request::is('admin/customer/subscriber-list') ? 'active' : '' }}">
                            ...
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <!-- <li
                                        class="nav-item d-none {{ Request::is('admin/delivery-man/chat') ? 'active' : '' }}">
                                    ...
                                    <!-- <li
                                        class="nav-item d-none  {{ Request::is('admin/delivery-man/withdraw-list') || Request::is('admin/delivery-man/withdraw-view*') ? 'active' : '' }}">
                                    ...
                                    <!-- <li
                                        class="nav-item d-none {{ Request::is('admin/delivery-man/emergency-contact') ? 'active' : '' }}">
                                        <a class="nav-link "
                            ...
                            {{-- @if (auth('admin')->user()->admin_role_id == 1)
                                <li
                                    class=" navbar-vertical-aside-has-menu {{ Request::is('admin/panel*') || Request::is('admin/custom-role*') ? 'active' : '' }}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                        href="javascript:" title="{{ \App\CPU\translate('employees') }}">
                                        <!-- <i class="tio-user nav-icon"></i> -->
                                        <i class="tio-users-switch nav-icon"></i>
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                            {{ \App\CPU\translate('Sub Admin Management') }}

                                            <!-- {{ \App\CPU\translate('Franchise/District/State') }} -->
                                        </span>
                                    </a>
                                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                        style="display: {{ Request::is('admin/panel*') || Request::is('admin/custom-role*') ? 'block' : 'none' }}">
                                        <li
                                            class="  navbar-vertical-aside-has-menu {{ Request::is('admin/custom-role*') ? 'active' : '' }}">
                                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                                href="{{ route('admin.custom-role.create') }}"
                                                title="{{ \App\CPU\translate('Sub Admin Role Setup') }}">
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span
                                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                                    Role Setup</span>
                                        ...
                                        <li
                                            class="nav-item {{ Request::is('admin/panel/admin-list') || Request::is('admin/panel/add-new-admin') ? 'active' : '' }}">
                                            <a class="nav-link" href="{{ route('admin.employee.list') }}"
                                                title="{{ \App\CPU\translate('Sub Admin List') }}">
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span
                                                    class="text-truncate">{{ \App\CPU\translate('Sub Admin List') }}</span>
                                            </a>
                                        </li>
                                        ...
                                        <!-- <li
                                            class=" d-none
                                             nav-item {{ Request::is('admin/panel/withdrawal_list') || Request::is('admin/panel/add-new') || Request::is('admin/panel/update*') ? 'active' : '' }}">
                                            <a class="nav-link" href="{{ route('admin.employee.withdrawal_list') }}"
                                                title="{{ \App\CPU\translate('Withdrawal_list') }}">
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span
                                                    class="text-truncate">{{ \App\CPU\translate('withdrawal_list') }}</span>
                                            </a>
                                        </li>
                                        <li
                                            class=" d-none
                                             nav-item {{ Request::is('admin/panel/kyc_list') || Request::is('admin/panel/add-new') || Request::is('admin/panel/update*') ? 'active' : '' }}">
                                            <a class="nav-link" href="{{ route('admin.employee.kyc_list') }}"
                                                title="{{ \App\CPU\translate('kyc_list') }}">
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span
                                                    class="text-truncate">{{ \App\CPU\translate('Kyc_Request_List') }}</span>
                                            </a>
                                        </li> -->
                                    </ul>
                                </li>
                        ...
                        @if (auth('admin')->user()->admin_role_id != 1)
                            <!-- <li
                                class=" d-none navbar-vertical-aside-has-menu {{ Request::is('admin/plan/my_withdrawal_list') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('admin.plan.my_withdrawal_list') }}"
                                    title="{{ \App\CPU\translate('My_Withdrawal_List') }}">
                                    <i class="tio-chart-bar-4 nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        <span class="position-relative">
                                            {{ \App\CPU\translate('My_Withdrawal_List') }}
                                        </span>
                                    </span>
                                </a>
                            </li>
                            <li
                                class=" d-none navbar-vertical-aside-has-menu {{ Request::is('admin/dashboard/bonus_list') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('admin.dashboard.bonus_list') }}"
                                    title="{{ \App\CPU\translate('My_Earning_bonus_List') }}">
                                    <i class="tio-chart-bar-4 nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        <span class="position-relative">
                                            {{ \App\CPU\translate('My_Earning_bonus_List') }}
                                        </span>
                                    </span>
                                </a>
                            </li>
                            <li
                                class=" d-none navbar-vertical-aside-has-menu {{ Request::is('admin/dashboard/my_kyc') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('admin.dashboard.my_kyc') }}"
                                    title="{{ \App\CPU\translate('My_KYC') }}">
                                    <i class="tio-chart-bar-4 nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        <span class="position-relative">
                                            {{ \App\CPU\translate('My_KYC') }}
                                        </span>
                                    </span>
                                </a>
                            </li> -->
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/profile/update/' . auth('admin')->user()->id) ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('admin.profile.update', auth('admin')->user()->id) }}"
                                    title="{{ \App\CPU\translate('my_profile') }}">
                                    <i class="tio-chart-bar-4 nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        <span class="position-relative">
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin.auth.logout') ? 'active' : '' }}">
                            ...
                            Swal.fire('Canceled', '', 'info')
                                    ...
                                    title="{{ \App\CPU\translate('sign_out') }}">
                                    <i class="tio-chart-bar-4 nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        <span class="position-relative">
                                            {{ \App\CPU\translate('sign_out') }}
                                        </span>
                                    </span>
                                </a>
                        ...
                        @if (\App\CPU\Helpers::module_permission_check('system_settings'))
                            ...
                            {{-- <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/business-settings/web-config') || Request::is('admin/business-settings/web-config/app-settings') || Request::is('admin/product-settings/inhouse-shop') || Request::is('admin/business-settings/seller-settings') || Request::is('admin/customer/customer-settings') || Request::is('admin/refund-section/refund-index') || Request::is('admin/business-settings/shipping-method/setting') || Request::is('admin/business-settings/order-settings/index') || Request::is('admin/product-settings') || Request::is('admin/business-settings/web-config/delivery-restriction') || Request::is('admin/business-settings/cookie-settings') || Request::is('admin/business-settings/otp-setup') || Request::is('admin/business-settings/all-pages-banner*') || Request::is('admin/business-settings/delivery-restriction') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu d-none  {{ Request::is('admin/business-settings/mail') || Request::is('admin/business-settings/sms-module') || Request::is('admin/business-settings/captcha') || Request::is('admin/social-login/view') || Request::is('admin/social-media-chat/view') || Request::is('admin/business-settings/map-api') || Request::is('admin/business-settings/payment-method') || Request::is('admin/business-settings/fcm-index') ? 'active' : '' }}">
                            ...
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        class="navbar-vertical-aside-has-menu {{ Request::is('admin/business-settings/social-media') ? 'active' : '' }}  d-none  ">
                                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    ...
                                    <li
                                        class="navbar-vertical-aside-has-menu {{ Request::is('admin/file-manager*') ? 'active' : '' }}  d-none  ">
                                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu  d-none {{ Request::is('admin/business-settings/web-config/environment-setup') || Request::is('admin/business-settings/web-config/mysitemap') || Request::is('admin/business-settings/analytics-index') || Request::is('admin/currency/view') || Request::is('admin/business-settings/web-config/db-index') || Request::is('admin/business-settings/language*') || Request::is('admin/business-settings/web-config/theme/setup') || Request::is('admin/system-settings/software-update') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
