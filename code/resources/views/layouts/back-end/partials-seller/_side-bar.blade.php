            ...
            <div class="navbar-vertical-footer-offset pb-0">
                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('seller/pos') ? 'active' : '' }} d-none">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        @if (auth('seller')->user()->type === 'goods' || auth('seller')->user()->type === 'both')
                        <li class="nav-item">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('seller/orders*') ? 'active' : '' }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li
                                    ...
                                    <a class="nav-link "
                                        href="{{ route('seller.orders.list', ['out_for_delivery']) }}" title="">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">
                        ...
                        @if (auth('seller')->check() && (auth('seller')->user()->type === 'goods' || auth('seller')->user()->type === 'both'))
                        ...
                        <li
                            class="d-none navbar-vertical-aside-has-menu {{ Request::is('seller/reviews/list*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        <li
                            class="d-none navbar-vertical-aside-has-menu {{ Request::is('admin/deal/flash') || Request::is('admin/deal/update*') ? 'active' : '' }}  ">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        <!-- <li
                            class="d-none navbar-vertical-aside-has-menu {{ Request::is('seller/coupon*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                        ...
                        <li
                            class="d-none navbar-vertical-aside-has-menu {{ Request::is('seller/messages*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:">
                        ...
                        @if (auth('seller')->user()->type === 'service' || auth('seller')->user()->type === 'both')
                        <li class="nav-item {{ Request::is('seller/transaction/order-list') ? 'scroll-here' : '' }}">
                            <small class="nav-subtitle" title="">
                                {{ \App\CPU\translate('Service Booking management') }}
                            </small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>

                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('seller/service/list/in_house') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('seller.service.list', ['in_house', '']) }}"
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('seller/bookings/list/doctor-appointment') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('seller.bookings.doctorAppointment') }}"
                        ...
                        <li class="nav-item {{ Request::is('seller/plan*') ? 'scroll-here' : '' }}">
                            <small class="nav-subtitle" title="">
                                {{ \App\CPU\translate('Subscription') }} & {{ \App\CPU\translate('Section') }}
                            </small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>

                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('seller/plan/plan-list') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('seller.plan.plan-list') }}"
                                title="{{ \App\CPU\translate('Subscription List') }}">
                                <i class="tio-filter-list nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ \App\CPU\translate('Subscription List') }}</span>
                            </a>
                        </li>

                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('seller/plan/plantransactions') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('seller.plan.plantransactions') }}"
                        ...
                        <!-- <li
                            class="d-none navbar-vertical-aside-has-menu {{ Request::is('seller/business-settings/bonus*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('seller.business-settings.bonus.list') }}">
                                <i class="tio-wallet-outlined nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate text-capitalize">
                        ...
                        <li
                            class="d-none navbar-vertical-aside-has-menu {{ Request::is('seller/profile/view') || Request::is('seller/profile/bank-edit/*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        <li
                            class="d-none navbar-vertical-aside-has-menu {{ Request::is('seller/delivery-man*') ? 'active' : '' }}">
