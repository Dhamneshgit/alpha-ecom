...
<body class="footer-offset">
    ...
    <span class="d-none" id="placeholderImg"
        data-img="{{ asset('public/assets/back-end/img/400x400/img3.png') }}"></span>
    {{-- loader --}}
    <div class="row">
    ...
    if (!empty($manufacturer_id)) {
        $all = \App\Model\Order::where(['manufacturer_id' => $manufacturer_id])->count();
        $pending_count = \App\Model\Order::where(['order_status' => 'pending', 'manufacturer_id' => $manufacturer_id])->count();
        $confirmed_count = \App\Model\Order::where(['order_status' => 'confirmed', 'manufacturer_id' => $manufacturer_id])->count();
        $delivered_count = \App\Model\Order::where(['order_status' => 'delivered', 'manufacturer_id' => $manufacturer_id])->count();
        $canceled_count = \App\Model\Order::where(['order_status' => 'canceled', 'manufacturer_id' => $manufacturer_id])->count();
    } elseif (!empty($aggregator_id)) {
        $all = \App\Model\Order::where(['aggregator_id' => $aggregator_id])->count();
        $pending_count = \App\Model\Order::where(['order_status' => 'pending', 'aggregator_id' => $aggregator_id])->count();
        $confirmed_count = \App\Model\Order::where(['order_status' => 'confirmed', 'aggregator_id' => $aggregator_id])->count();
        $delivered_count = \App\Model\Order::where(['order_status' => 'delivered', 'aggregator_id' => $aggregator_id])->count();
        $canceled_count = \App\Model\Order::where(['order_status' => 'canceled', 'aggregator_id' => $aggregator_id])->count();
    } else {
        $all = \App\Model\Order::count();
        $pending_count = \App\Model\Order::where(['order_status' => 'pending'])->count();
        $confirmed_count = \App\Model\Order::where(['order_status' => 'confirmed'])->count();
        $delivered_count = \App\Model\Order::where(['order_status' => 'delivered'])->count();
        $canceled_count = \App\Model\Order::where(['order_status' => 'canceled'])->count();
    }
    ...
    @include(
        'layouts.back-end.partials._side-bar',
        compact('all', 'pending_count', 'confirmed_count', 'delivered_count', 'canceled_count'))
