...
@section('content')
<div class="container loginContainerDiv py-4 py-lg-5 my-4 __inline-7 d-flex"
    ...
    <div class="row justify-content-center col-md-7">
        <div class="col-md-12">
            <div class="card border-0 box-shadow loginContainer">
                <div class="card-body">
                    <h2 class="h4 mb-1 primaryColor">{{\App\CPU\translate('sign_up')}}</h2>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" value="{{old('l_name')}}" name="l_name" placeholder="last name"
                                        style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" value="{{old('phone')}}" name="phone"
                                        style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"
                                     placeholder="mobile number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength); this.setCustomValidity(this.value.length < 10 ? 'Minimum length is 10 digits.' : ''); this.value = this.value.replace(/[^0-9]/g, '');" maxlength="10" required>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" value="{{old('address')}}" id="customer_address" name="address"
                                        style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="reg-ln">{{\App\CPU\translate('State')}}</label>
                                    <input class="form-control" id="customer_state" type="text" value="{{old('State')}}" name="state"
                                        style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};" placeholder="state" required>
                                    <div class="invalid-feedback">{{\App\CPU\translate('Please enter your State')}}!
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="customer_city" type="text" value="{{old('City')}}" name="city"
                                        style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};" placeholder="city" required>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="reg-ln">{{\App\CPU\translate('zipcode')}}</label>
                                    <input class="form-control" id="customer_zipcode" type="text" value="{{old('City')}}" name="zipcode"
                                        style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};" placeholder="zipcode" required>
                                    <div class="invalid-feedback">{{\App\CPU\translate('Please enter your zipcode')}}!
                                    </div>
                                </div>
                            </div>
