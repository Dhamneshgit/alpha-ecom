...
<script>
    ...
    var clickCountPlus = 0;  // To track the number of times plus is clicked
    var clickCountMinus = 0; // To track the number of times minus is clicked
    ...
    $('.btn-number').click(function (e) {
        ...
        var stepSize = parseInt(input.attr('step-size'));

        if (!isNaN(currentVal)) {
            if (type == 'minus') {
                // Increase click count for minus
                clickCountMinus++;
    ...
    $('.input-number').change(function () {
        ...
        var stepSize = parseInt($(this).attr('step-size'));
