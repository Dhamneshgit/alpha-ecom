                                            ...
                                            <div id="collapseThree"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                               name="phone" {{$shipping_addresses->count()==0?'required':''}} maxlength="10">
                                                    </div>
                                                    <div class="form-group">
                                                        <label
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @else
                                                        <input type="text" class="form-control"
                                                               name="zip" {{$shipping_addresses->count()==0?'required':''}} maxlength="6">
                                                        @endif
                                                    </div>
                                                    <div class="form-group">
                                                        <label
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">{{ \App\CPU\translate('Phone')}}
                                                            <span
                                                                class="text-danger">*</span></label>
                                                        <input type="number" class="form-control" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength); this.setCustomValidity(this.value.length < 10 ? 'Minimum length is 10 digits.' : ''); this.value = this.value.replace(/[^0-9]/g, '');"
                                                            name="billing_phone" {{$billing_addresses->count()==0?'required':''}} maxlength="10">
                                                    </div>
                                                    </div>
                                                    <div class="inputWrapper">
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @else
                                                            <input type="text" class="form-control"
                                                                   name="billing_zip" {{$billing_addresses->count()==0?'required':''}} maxlength="6">
                                                        @endif
