    ...
    <div class="container mb-md-4 {{Session::get('direction') === "rtl" ? 'rtl' : ''}} __inline-65">
        ...
        <div class="row">
            ...
            <section class="col-lg-12">
                <!-- Products grid-->
                <div class="row mx-n2 __min-h-200px sellerCardDiv">
                    @foreach($sellers as $shop)
                        <div class="text-center">
                            <div class="card-body shadow position-relative sellerCard">
                                ...
                                <a href="{{route('shopView',['id'=>$shop['seller_id']])}}">
                                    <img class="__inline-66"
                                         ...
                                         <div class="text-center text-dark">
                                             <span class="text-center font-weight-bold small p-1 sellerText">{{$shop->name}}</span>
                                         </div>
                        </div>
                    @endforeach
                </div>
