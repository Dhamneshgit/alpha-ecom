...
@section('title',\App\CPU\translate('category service Page'))
    ...
    <div class="container pb-5 mb-2 mb-md-4 rtl" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
        ...
        <div class="row">
            ...
            <section class="col-lg-12">
                <!-- Products grid-->
                <div class="row brandCardRow">
                    @foreach($brands as $brand)
                        <div class="brandcard">
                            <a href="{{ route('services', ['id' => $brand['id']]) }}">
                                <img onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'" src="{{asset("storage/app/public/category/$brand->icon")}}" alt="{{$brand->name}}">
                            </a>
                            <p>{{$brand['name']}}</p>
                        </div>
                    @endforeach
