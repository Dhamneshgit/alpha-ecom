...
{{-- @php($servicecategories = \App\Model\ServiceCategory::get()) --}}
<div class="__inline-61">
    @php($decimal_point_settings = !empty(\App\CPU\Helpers::get_business_settings('decimal_point_settings')) ?
    \App\CPU\Helpers::get_business_settings('decimal_point_settings') : 0)
    <!-- Hero (Banners + Slider)-->
    ...
    @if ($web_config['flash_deals'])
        <section style="display: none;" class="overflow-hidden">
            <div class="container">
    ...
    @if($web_config['brand_setting'])
        <section class="container rtl mt-5">
            ...
            <!-- <div class="section-header ">
                <div class="text-black font-bold subHeading main-sub-head">
                    <span> {{\App\CPU\translate('brands')}}</span>
                </div>
                <div class="__mr-2px d-flex align-items-center">
                    <a class="text-capitalize view-all-text secondryColor" href="{{route('brands')}}">
                        {{ \App\CPU\translate('view_all')}}
                        <i
                            class="czi-arrow-{{Session::get('direction') === "rtl" ? 'left mr-1 ml-n1 mt-1 float-left' : 'right ml-1 mr-n1'}}"></i>
                    </a>
                        ...
                        @foreach($brands as $brand)
                            <div class="swiper-slide mt-2">
                                <div class="serviceCard">
                                    ...
                                    <p class="img-tittle-top">{{ $brand['name'] }}</p>
                                </div>
                            </div>
                        @endforeach
                    </div>
    ...
    {{-- <section class="serviceSection">
        <div class="container">
            <div class="section-header mb-5">
                <div class="text-black font-bold subHeading">
                    <span>{{ \App\CPU\translate('Services Category') }}</span>
                </div>
                <div class="__mr-2px d-flex align-items-center">
                    <a class="text-capitalize view-all-text secondryColor" href="{{ route('service-category') }}">
                        {{ \App\CPU\translate('view_all') }}
                        <i
                            class="czi-arrow-{{ Session::get('direction') === 'rtl' ? 'left mr-1 ml-n1 mt-1 float-left' : 'right ml-1 mr-n1' }}"></i>
                    </a>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        @foreach($servicecategories as $category)
                            <div class="swiper-slide">
                                <div class="serviceCard">
                                    <div class="serviceCardImg ">
                                        <a href="{{ route('services', ['id' => $category['id']]) }}">
                                            <img onerror="this.src='{{ asset('public/assets/front-end/img/image-place-holder.png') }}'"
                                    ...
                                    <p class="img-tittle">{{ $category['name'] }}</p>
                                </div>
                            </div>
                        @endforeach
                    </div>
                ...
                <div class="swiper service-Card">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="serviceCard">
                                <div class="serviceCardImg">
                                    <img src="https://townway.alphawizzserver.com/storage/app/public/category/2024-11-27-6747322d9daa8.png"
                                        alt="">
                                </div>
                                <p>Electronic</p>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="serviceCard">
                                <div class="serviceCardImg">
                                    <img src="https://townway.alphawizzserver.com/storage/app/public/brand/2024-11-28-674827b6d65c8.png"
                                        alt="">
                                </div>
                                <p>Bikes</p>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="serviceCard">
                                <div class="serviceCardImg">
                                    <img src="https://townway.alphawizzserver.com/storage/app/public/category/2024-11-28-67482369449a4.png"
                                        alt="">
                                </div>
                                <p>Garments</p>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="serviceCard">
                                <div class="serviceCardImg">
                                    <img src="https://townway.alphawizzserver.com/storage/app/public/category/2024-11-28-67480afd16e3e.png"
                                        alt="">
                                </div>
                                <p>Groceries</p>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="serviceCard">
                                <div class="serviceCardImg">
                                    <img src="https://townway.alphawizzserver.com/storage/app/public/category/2024-11-28-67483c2e0bbf5.png"
                                        alt="">
                                </div>
                                <p>Sports</p>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="serviceCard">
                                <div class="serviceCardImg">
                                    <img src="https://townway.alphawizzserver.com/storage/app/public/product/thumbnail/2024-12-16-67602b328f72d.png"
                                        alt="">
                                </div>
                                <p>Foods</p>
                            </div>
    ...
    <div class="container rtl mt-4">
        <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mt-3">
                                @foreach($categories as $key => $category)
                                    ...
                                    @if ($key < 10)
                                        <div class="text-center __m-5px __cate-item categoryCard">
                                            <a
                                                ...
                                                <p class="text-center small borderTop">{{Str::limit($category->name, 12)}}</p>
                                            </a>
                                        </div>
                                    @endif
            ...
            @else
                <div class="col-md-12">
                    <div class="card h-100">
                        <div class="card-body car-body-div">
                            <div class="row d-flex justify-content-between">
                                <div
            ...
            <div class="col-md-6 mt-4 seller-card">
                <div class="card __shadow h-100">
                    <div class="card-body">
                        <div class="row d-flex justify-content-between">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="__m-5px __cate-item">
                                <a href="{{route('shopView', ['id' => $seller['id']])}}">
                                    ...
                                    <p class="text-center small mt-2">{{$seller->shop->name}}</p>
                                </a>
                            </div>
                            @endif
                            @endif
    ...
    {{-- <div class="container rtl">
        <div class="row g-3">
                        ...
                        <div>
                            ...
                            <a class="__best-selling" href="{{route('product', $bestSell->product->slug)}}">
                                ...
                                <div class="d-flex flex-wrap p-2">
                                    <div class="best-selleing-image col-6">
                                        <img class="rounded"
                                            onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                    ...
                                    <div class="best-selling-details">
                                        <div class="productHead">
                                            <h6>
                                                <span class="widget-product-title">
                                                    {{\Illuminate\Support\Str::limit($bestSell->product['name'], 100)}}
                                                </span>
                                            </h6>
                                            @php($bestSell_overallRating =
                                            \App\CPU\ProductManager::get_overall_rating($bestSell->product['reviews']))
                                            <div class="rating-show">
                                                <span class="d-inline-block font-size-sm text-body">
                                                    @for($inc = 0; $inc < 1; $inc++)
                                                    ...
                                                    @endfor
                                                    <label
                                                        class="badge-style">({{$bestSell->product->reviews_count}})</label>
                                                </span>
                                            </div>
                                        </div>
            ...
            $bestSell->product->unit_price - (\App\CPU\Helpers::get_product_discount($bestSell->product, $bestSell->product->unit_price))
                                            ...
                                            <div>
                                                @if($bestSell->product->discount > 0)
                                                    <strike class="__color-E96A6A __text-12px p-0">
                        ...
                        <div>
                            ...
                            <a class="__best-selling" href="{{route('product', $top->product->slug)}}">
                                ...
                                <div class="d-flex p-2">
                                    <div class="top-rated-image col-6">
                                        <img class="rounded"
                                            onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                    ...
                                    <div class="top-rated-details">
                                        <div class="productHead">
                                            ...
                                            @php($top_overallRating =
                                            \App\CPU\ProductManager::get_overall_rating($top->product['reviews']))
                                            <div class="rating-show">
                                                <span class="d-inline-block font-size-sm text-body">
                                                    @for($inc = 0; $inc < 1; $inc++)
                                        ...
                                        <!-- <div class="productPara">
                                                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ipsum sapiente vero sint minima, mollitia praesentium labore doloremque? Voluptatum, quas dignissimos consequatur quisquam ullam at quos optio.
                                                    </div> -->
                                        <div class="product-price">
                                            <div class="widget-product-meta">
                                                <span class="text-accent">
            ...
            $top->product->unit_price - (\App\CPU\Helpers::get_product_discount($top->product, $top->product->unit_price))
                                            ...
                                            <div>
                                                @if($top->product->discount > 0)
                                                    <strike class="__text-12px __color-E96A6A p-0">
    ...
    <!-- Textimonial Section Start -->
    <section class="testimonialSection d-none">
        <div class="container">
            <div class="section-header mb-4">
                <div class="text-black font-bold subHeading">
            ...
            <div class="swiper testimonial-Card">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="testimonialCard">
                            <div class="testimonialCardHead">
                                <div class="testimonialImg">
                                    <img src="{{asset("public/assets/front-end/png/boy.png")}}" alt="">
                                    <p>Waseem Ahmed</p>
                                </div>
                                <div class="rating-show justify-content-between text-center">
                                    <span class="d-inline-block font-size-sm text-body" style="font-weight: 400;
                                            font-size: 10px;">
                                        <i class="sr-star czi-star-filled" style="color:#fea569 !important"></i>
                                        <label class="badge-style">(4.5)</label>
                                    </span>
                                </div>
                            </div>
                            <div class="testimonialPara">
                                <img src="{{asset("public/assets/front-end/png/quote.svg")}}" alt="">
                ...
                <div class="swiperBtnDiv">
                    <div class="testimonialPrev"><i class="czi-arrow-left"></i></div>
                    <div class="testimonialNext"><i class="czi-arrow-right"></i></div>
                </div>
            </div>
    </section>
            ...
            <div class="row g-3">
                <div class="col-md-3 d-flex justify-content-center ">
                    <div class="shipping-method-system">
                        <div class="text-center text-call">
                            <img class="size-60" src="{{asset("public/assets/front-end/png/delivery.png")}}" alt="">
                        </div>
                        <div class="text-center">
                            <p class="m-0">
                ...
                <div class="col-md-3     d-flex justify-content-center ">
                    <div class="shipping-method-system">
                        <div class="text-center">
                            <img class="size-60" src="{{asset("public/assets/front-end/png/Payment.png")}}" alt="">
                        </div>
                        <div class="text-center">
                            <p class="m-0">
                ...
                <div class="col-md-3 d-flex justify-content-center">
                    <div class="shipping-method-system">
                        <div class="text-center">
                            <img class="size-60" src="{{asset("public/assets/front-end/png/money.png")}}" alt="">
                        </div>
                        <div class="text-center">
                            <p class="m-0 title-bottom">
                ...
                <div class="col-md-3 d-flex justify-content-center">
                    <div class="shipping-method-system">
                        <div class="text-center">
                            <img class="size-60" src="{{asset("public/assets/front-end/png/Genuine.png")}}" alt="">
                        </div>
                        <div class="text-center">
                            <p class="m-0 ">
...
@push('script')
    ...
    <!-- Initialize Swiper -->
    <script>
        var swiper = new Swiper(".brand-Card", {
            autoplay: {
                delay: 4000,
            },
            loop: true,
    ...
    <script>
        var swiper = new Swiper(".testimonial-Card", {
            navigation: {
