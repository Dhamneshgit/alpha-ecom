            ...
            <div class="col-lg-12 mt-2">
                <div class="bg-white">
                    ...
                    @else
                        ...
                        <img class="__shop-page-banner" src="{{ asset('storage/app/public/shop') }}/{{ $banner ?? '' }}"
                            onerror="this.src='{{ asset('public/assets/front-end/img/image-place-holder.png') }}'"
                            alt="">
                    @endif
                </div>
                            ...
                            <div class="col-md-8">
                                {{-- <span class="ml-4 font-weight-bold ">
                                    @if ($shop['id'] != 0)
                                        ...
                                        <p class="mb-0"><small>Contact : {{ $shop->contact }}</small></p>
                                        <p class="mb-0"><small>address : {{ $shop->address }}</small></p>
                                    @else
                                        <p class="mb-0">{{ $web_config['name']->value }}</p>
                                    @endif
                                </span> --}}
                                <span class="ml-4 font-weight-bold ">
                                    @if ($seller && $seller->id != 0)
                                        <p class="mb-0">{{ $seller->f_name . ' ' . $seller->l_name }}</p>
                                        <p class="mb-0"><small>Contact : {{ $seller->phone }}</small></p>
                                        <p class="mb-0"><small>address : {{ $seller->address }}</small></p>
                                    @else
                                        <p class="mb-0">{{ $web_config['name']->value }}</p>
                                    @endif
                                </span>
...
@else
    ...
    @endif
                ...
                @if (isset($shop->temporary_close) &&
                        ($shop->temporary_close ||
                            ($shop->vacation_status &&
                                date('Y-m-d') >= date('Y-m-d', strtotime($shop->vacation_start_date)) &&
                                date('Y-m-d') <= date('Y-m-d', strtotime($shop->vacation_end_date)))))
                    <span></span>
                @else
                    {{-- Modal --}}
        ...
        <div class="row mt-1 mr-0 rtl">
            ...
            <div class="col-lg-3 mt-3 shopCategory  mr-0 {{ Session::get('direction') === 'rtl' ? 'pl-0' : 'pr-0' }}">
                    ...
                    <div class=" rounded-lg " id="shop-sidebar">
                        <div class="">
                            ...
                            <div class="widget widget-categories mb-4 ">
                                <div>
                                    <div class="d-inline">
                                        <h3 class="widget-title font-bold __text-18px d-inline pl-3">
                                            {{ \App\CPU\translate('categories') }}</h3>
                                    </div>
                                </div>

                                <div class="accordion mt-2 shopCategoryList" id="shop-categories">
            ...
            <div class="col-lg-9 product-div">
                <div class="row d-flex">
                    <div class="col-lg-12 col-md-6 col-sm-12 col-12 pt-2 __dir-ltr">
                        <form class="{{-- form-inline --}} md-form form-sm mt-0" method="get"
                            action="{{ route('shopView', ['id' => $seller_id]) }}">
                            <div class="input-group input-group-sm searchInputCategory">
