        ...
        <div class="row">   <!-- Sidebar-->
            <section class="col-lg-12 mt-3">
                <section class="container pt-4 pb-5 ">
                    <div class="row pt-4">
                        <div class="col-sm-5 loginImg">
                            <img src={{asset("public/assets/front-end/img/faq1.png")}} alt="">
                        </div>
                        <div class="col-sm-7">
                            <ul class="list-unstyled">
                                ...
                                @for($i=0;$i<$first;$i++)
                                    <div id="accordion" class="faqListContainer">
                                        <div class="faqDiv">
                                                ...
                                                <button class="btnF btn-link collapsed" data-toggle="collapse"
                                                    ...
                                                    <li class="d-flex align-items-center border-bottom">{{ $helps[$i]['question'] }}</li>
                                                </button>
                                            </div>
                                            <div class="">
                                                <i class="czi-arrow-down text-muted"></i>
                                                </div>
                                        </div>
