    ...
    <div class="__customer-sidebar" id="shop-sidebar">
        <div>
            ...
            <div class="widget-title">
                <a class="{{ Request::is('account-oder*') || Request::is('account-order-details*') ? 'active-menu' : '' }}"
                    href="{{ route('account-oder') }} ">{{ \App\CPU\translate('my_order') }}</a>
            </div>
        </div>
        {{-- <div>
            <div class="widget-title">
                <a class="{{ Request::is('my-service') || Request::is('service-order-details') ? 'active-menu' : '' }}"
                    href="{{ route('my-service') }} ">{{ \App\CPU\translate('my_booking') }}</a>
            </div>
        </div> --}}
        <div>
            <div class="widget-title">
                <a class="{{ Request::is('return-orders') || Request::is('return-order-details') ? 'active-menu' : '' }}"
                    href="{{ route('return-orders') }} ">{{ \App\CPU\translate('return_orders') }}</a>
            </div>
        </div>
            ...
            <div>
                ...
                <div class="widget-title">
                    <a class="{{ Request::is('wallet') ? 'active-menu' : '' }}"
                        href="{{ route('wallet') }} ">{{ \App\CPU\translate('my_wallet') }} </a>
                </div>
            </div>
        @endif
        @if ($web_config['loyalty_point_status'] == 1)
            <div>
                <!-- Filter by price-->
                <div class="widget-title">
                    <a class="{{ Request::is('loyalty') ? 'active-menu' : '' }}"
                        href="{{ route('loyalty') }} ">{{ \App\CPU\translate('my_loyalty_point') }}</a>
                </div>
            </div>
        @endif
        <div>
            <!-- Filter by price-->
            <div class="widget-title">
                <a class="{{ Request::is('track-order*') ? 'active-menu' : '' }}"
                    href="{{ route('track-order.index') }} ">{{ \App\CPU\translate('track_your_order') }}</a>
            </div>
        </div>
        <div>
            <!-- Filter by price-->
