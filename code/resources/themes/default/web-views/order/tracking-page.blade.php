...
@section('content')
    <!-- Page Content-->
    <div class="container rtl py-5 d-flex loginContainerDiv" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
        <div class="col-md-5 loginImg">
            <img src="{{asset("public/assets/front-end/img/track.png")}}" alt="">
        </div>
        <div class="col-md-7">
            <h3 class="text-center text-capitalize primaryColor">{{\App\CPU\translate('track_order')}}</h3>
