...
@section('content')
    ...
    <div class="container text-center">
        <h3 class="headerTitle my-3">{{\App\CPU\translate('return_orders')}}</h3>
    </div>
{{-- @dd($return_orders); --}}
    <!-- Page Content-->
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td class="bodytr">
                                            <div class="__btn-grp-sm flex-nowrap">
                                                <a href="{{ route('return-order-details', ['id'=>$order->id]) }}"
                                                ...
                                                @if($order['payment_method']=='cash_on_delivery' && $order['order_status']=='pending')
                                                    ...
                                                    class="btn btn-danger __action-btn d-none">
                                                        <i class="fa fa-trash"></i>
                                                    </a>
                                                @else
                                                    <button class="btn btn-danger __action-btn d-none" title="{{\App\CPU\translate('Cancel')}}" onclick="cancel_message()">
                                                        <i class="fa fa-trash"></i>
                                                    </button>
                                                @endif
                                            </div>
                            ...
                            @if($return_orders->count()==0)
                                <center class="mb-2 mt-3">{{\App\CPU\translate('no_order_returned')}}</center>
                            @endif
