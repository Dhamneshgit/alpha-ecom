                            ...
                            <div class="tab-content">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        @else
                                            <input class="form-control" type="number" id="zip" name="zip" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength); this.setCustomValidity(this.value.length < 6 ? 'Minimum length is 6 digits.' : ''); this.value = this.value.replace(/[^0-9]/g, '');" maxlength="6" required>
                                        @endif
                                    </div>
                                </div>
                                <div class="form-row">
