                    ...
                    <div class="card-header">
                        <form class="mt-3 px-sm-2 pb-2" action="{{route('user-update')}}" method="post"
                            ...
                            <div class="row photoHeader g-3">
                                ...
                                <div class="card-body mt-md-3 p-0 profileInputDiv">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6 mb-0">
                                            ...
                                            <input type="text" class="form-control" id="f_name" name="f_name"
                                                   value="{{$customerDetail['f_name']}}" placeholder="first name" required>
                                        </div>
                                        </div>
                                        <div class="form-group col-md-6 mb-0">
                                            ...
                                            value="{{$customerDetail['l_name']}}" placeholder="last name">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6 mb-0">
                                        ...
                                        <div class="inputFeald">
                                            ...
                                            <input type="email" class="form-control" type="email" id="account-email"
                                                   value="{{$customerDetail['email']}}" placeholder="email" disabled>
                                        </div>
                                        </div>
                                        <div class="form-group col-md-6 mb-0">
                                            ...
                                            <input type="text" class="form-control" type="text" id="phone"
                                                   name="phone" value="{{$customerDetail['phone']}}" maxlength="10" 
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6 mb-0">
                                            ...
                                            <div class="password-toggle">
                                                <div class="inputFeald">
                                                <i class="navbar-tool-icon czi-locked"></i>
                                        ...
                                        <div class="col-12 d-flex flex-wrap justify-content-between __gap-15 __profile-btns justify-content-center">
