...
@section('content')
    ...
    <div class="d-flex w-100 justify-content-center align-items-center mb-3 __min-h-70px __inline-35"
        ...
        <div class="text-capitalize container text-center">
            <span class="__text-18px font-semibold">{{ \App\CPU\translate(str_replace('_', ' ', $data['data_from'])) }}
                ...
                {{ isset($data['brand_name']) ? '(' . $data['brand_name'] . ')' : '' }}</span>
        </div>
    ...
    <div class="container pb-5 mb-2 mb-md-4 rtl __inline-35"
        ...
        <div class="row">
            <!-- Sidebar-->
            <aside
                class="hidden-xs col-md-4 col-sm-4 SearchParameters __search-sidebar {{ Session::get('direction') === 'rtl' ? 'pl-2' : 'pr-2' }}"
                id="SearchParameters">
                <!--Price Sidebar-->
                <div class="cz-sidebar box-shadow-lg __inline-35 sideVarFilter" id="shop-sidebar">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="text-center">
                            ...
                            {{-- from here --}}
                            <div class="price-slider position-relative">
                                <!-- Single Slider -->
                                <input type="range" id="price_slider" class="slider" min="0"
                                    max="{{ $products->max('unit_price') }}"
                                    value="{{ $products->max('unit_price') / 2 }}"
                                    oninput="updatePriceValue(this.value)" />

                                <!-- Tooltip -->
                                <div id="price_tooltip" class="tooltip">0</div>

                                <!-- Display Selected Price -->
                                <div class="selected-price text-center mt-2">
                                    Selected Price: <span id="price_value">{{ $products->max('unit_price') / 2 }}</span>
                                </div>
                            </div>
                            {{-- to here --}}
                            <div class="d-flex justify-content-between align-items-center __cate-side-price">
                                ...
                                <div class="__w-35p">
                                    <input value="{{ $products->max('unit_price') }}" min="100" max="1000000"
                                        class="bg-white cz-filter-search form-control form-control-sm appended-form-control"
                            ...
                            <div class="__cate-side-price pb-0">
                                <div class="input-group-overlay input-group-sm">
                                    <input style="{{ Session::get('direction') === 'rtl' ? 'padding-right: 32px;' : '' }}"
                                        placeholder="{{ \App\CPU\translate('search_by_brands') }}"
...
@push('script')
    ...
    <script>
        ...
        function syncPriceSlider(value) {
