            ...
            <div class="row {{ Session::get('direction') === 'rtl' ? '__dir-rtl' : '' }}">
                ...
                <div class="col-lg-9 col-12">
                    <div class="row">
                        ...
                        <!-- Product details-->
                        <div class="col-lg-7 col-md-8 col-12 mt-md-0 mt-sm-3 productcardHead"
                            ...
                            <div class="details __h-100">
                                <div class="productNameDiv">
                                    ...
                                    <div>
                                        ...
                                        <span
                                            class="d-inline-block  align-middle mt-1 {{ Session::get('direction') === 'rtl' ? 'ml-md-2 ml-sm-0 pl-2' : '' }} __color-FE961C">{{ $overallRating[0] }}</span>
                                ...
                                <form id="add-to-cart-form" class="mb-2">
                                    ...
                                    <div
                                        ...
                                        @if ($product->colors && is_array(json_decode($product->colors)) && count(json_decode($product->colors)) > 0)
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex justify-content-center align-items-center __w-160px"
                                                    ...
                                                    <input type="text" name="quantity"
                                                        ...
                                                        min="{{ $product->minimum_order_qty ?? 1 }}" max="{{ $product->current_stock }}"
                                                        step-size="{{ $product->qty_step_size ?? 1 }}">
                                                    <span class="input-group-btn">
                                                        <button class="btn btn-number __p-10" type="button"
                                    ...
                                    <div class="__btn-grp mt-2 mb-3 addtoCartDiv">
                                        @if (
                                            ...
                                            <button class="btn btn-secondary buynowBtn" type="button" disabled>
                                        ...
                                        @else
                                            <button
                                                class="buynowBtn btn btn-secondary element-center __iniline-26 btn-gap-{{ Session::get('direction') === 'rtl' ? 'left' : 'right' }}"
                                                onclick="buy_now()" type="button">
                                                <span class="string-limit">{{ \App\CPU\translate('buy_now') }}</span>
                                            </button>
                                            <button
                                                class="btn addtoCartBtn btn--primary element-center btn-gap-{{ Session::get('direction') === 'rtl' ? 'left' : 'right' }}"
                                        ...
                                        <button type="button" onclick="addWishlist('{{ $product['id'] }}')"
                                            class="btn __text-18px wishlistBtn text-danger">
                                            <i class="fa {{ $wishlist_status == 1 ? 'fa-heart' : 'fa-heart-o' }}"
                                ...
                                {{-- limks are here! --}}
                                {{-- <div style="display: none; text-align:{{Session::get('direction') === "rtl" ? 'right' : 'left'}};"
    ...
    @endif -->
                    ...
                    <div class="px-3 py-3">
                        <div class="row d-flex justify-content-center">
                            <span class="text-center __text-16px font-bold primaryColor">
        ...
        <div class="container  mb-3 rtl"
            ...
            <div class="row flex-between">
                <div class="text-capitalize font-bold __text-30px"
                    ...
                    <span style="color: #0068E8;">{{ \App\CPU\translate('similar_products') }}</span>
                </div>
